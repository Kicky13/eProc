            ...
            <table class="row" width="750" bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; text-align:left; border-spacing:0; max-width:100%; margin:0 auto;">
                <tr>
                    <td style="padding-top:25px; padding-left:30px; padding-right:30px; padding-bottom:20px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777;">
                        Vendor telah disetujui, akun telah aktif.<br>
                        Vendor       : <?php echo $vendorname ?><br>
                        Nomor Vendor : <?php echo $vendorno ?><br>
                        ...
                        <?php if($akutansi){ ?>
                            ...
                            Alamat        : <?php echo $street ?><br>
                            Kota          : <?php echo $city ?><br>
                            Kodepos       : <?php echo $postcode ?><br>
                            Negara        : <?php echo $country ?><br>
                            NPWP          : <?php echo $npwp ?><br>
                            Account Bank  : <?php echo $account_name ?><br>
                            No Rekening   : <?php echo $account_no ?><br>
                            Mata Uang     : <?php echo $currency ?><br>
                            Nomor Telp    : <?php echo $telp ?><br>
                            Nomor HP      : <?php echo $no_hp ?><br>
                        <?php } ?>
