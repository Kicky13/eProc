  ...
  <div class="content row_spacer clearfix" style="padding-top: 40px">
    ...
    <div class="rows_container clearfix">
      <div class="col-md-4 col-md-offset-4">
        <form class="login_form_colored" role="form" action="<?php echo base_url('Login_auction_bobot/doLoginVendor_simpel') ?>" method="POST">
          <div class="lfc_user_row">
            <span class="lfc_header">Login Free e-Auction</span>
          </div>
          <!--<div class="lfc_user_row">
