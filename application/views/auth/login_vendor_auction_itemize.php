  ...
  <div class="content row_spacer clearfix" style="padding-top: 40px">
    ...
    <div class="rows_container clearfix">
      <div class="col-md-4 col-md-offset-4">
        <form class="login_form_colored" role="form" action="<?php echo base_url('Login_vendor_auction_itemize/doLoginVendor_simpel') ?>" method="POST">
          <div class="lfc_user_row">
            <span class="lfc_header">Login Free e-Auction Itemize</span>
          </div>
          <!--<div class="lfc_user_row">
          ...
          <a class="lfc_forget_pass" href="Forget">Forgot Your Password?</a>
        </form>
      </div>
    </div>
  </div>
