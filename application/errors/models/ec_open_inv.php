...
class ec_open_inv extends CI_Model {

    protected $table = 'EC_GR', $tableHeader = 'EC_INVOICE_HEADER', $tableDenda = "EC_T_DENDA_INV", $tableDoc = "EC_T_DOC_INV", $tableCOMPANY = 'EC_C_COMPANY', $tablePURC_ORG = 'EC_C_PURC_ORG', $tableDOC = "EC_C_DOCTYPE", $tableTracking = "EC_TRACKING_INVOICE";
   ...
   (
      ...
      from
         ...
         left join
          ...
          left join EC_GR_LOT EGLOT
            ON ES.LOT_NUMBER = EGLOT.LOT_NUMBER-- Level Approval
          where ES.STATUS = 3 OR ES.STATUS IS NULL
      -- AWAL UNTUK MENCARI UNBILLED JASA
         UNION ALL
         SELECT
            YY.PO_NO,
