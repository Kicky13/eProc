...
class ec_master_inv extends CI_Model {
    ...
    protected $table = 'EC_M_PAJAK_INV', $tableDenda = 'EC_M_DENDA_INV', $tableDoc = 'EC_M_DOC_INV', $tableDocType = 'EC_M_DOC_TYPE', $tablePB = 'EC_M_PAY_BLOCK', $tablePM = 'EC_M_PAY_METHOD', $tablePT = 'EC_M_PAY_TERM', $tableMRole = 'EC_M_ROLE', $tableRoleUser = 'EC_ROLE_USER', $tableMappingUser = 'EC_USER_SAP_MAPPING', $TableLogCJ = "EC_LOG_CRON_JOB";
    ...
    public function getMappingUser($email) {
        $this->db->from($this->tableMappingUser);
        //$this->db->order_by('STATUS DESC');
        //$this -> db -> where("STATUS", "1", TRUE);
        $this->db->where('EMAIL1',$email);
