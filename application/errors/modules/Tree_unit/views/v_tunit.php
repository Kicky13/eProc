...
<div class="panel panel-info">
  ...
  <div class="modal fade bs-example-modal-lg"  role="dialog" aria-labelledby="myLargeModalLabel">
		 ...
		 <script>
			...
			$("#tree_menu").dynatree({
				initAjax: {url: "<?php echo base_url() ?>index.php/Tree_unit/getTree", 
               	},
...
//              });
        // .. but here we use a local file instead:
				node.appendAjax({
				  url: "<?php echo base_url() ?>index.php/Tree_unit/getTree_lazy",
		  ...
		  if(hapus==''){act=$('#simpandata31').val();}else{act=hapus;}
		   $(this).ajaxSubmit({
			...
			url:"<?php echo base_url()?>index.php/Tree_unit/crud",
			type:"post",       
			dataType:"JSON",   
			//clearForm: true,   
			//resetForm: true    
