                        ...
                        <?php endif ?>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" id="formInitialize" action="Vendor_regis_bypass/do_create_vendor" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                ...
                                                <button id="create" class="main_button color1 small_btn bottom_space">Create Account</button>
                                    </form>

                                    <!--?php echo form_close(); ?-->
                                                <input type="hidden" id="regis" name="regis">
                                                <input type="button" id="newregis" value="Create Account & Registration  >>" class="main_button color2 small_btn bottom_space">
