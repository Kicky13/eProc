		<section class="content_section">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open('Technical_document',array('class' => 'form-horizontal current_edited_good')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="no_edit" name="no_edit">
                                    </div>
                                </div>
                                 <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <button type="button" required class="uploadAttachment btn btn-default barang">Upload File (2MB Max)</button><span class="filenamespan"></span>
                                            &nbsp;&nbsp;
            ...
            <div class="modal fade" id="updateBahanModal" tabindex="-1" role="dialog" aria-labelledby="updateBahan">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open('Technical_document',array('class' => 'form-horizontal current_edited_bahan')); ?>
                                <input type="text" class="hidden" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="no_edit_bahan" name="no_edit_bahan">
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="updateServiceModal" tabindex="-1" role="dialog" aria-labelledby="updateService">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open('Administrative_document/do_insert_akta_pendirian',array('class' => 'form-horizontal current_edited_jasa')); ?>
                                <input type="text" class="hidden" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Klasifikasi<span style="color: #E74C3C">*</span></label>
                                    <div class="col-sm-5">
                                        <label class="custom_select">
                                            <span class="lfc_alert"></span>
                                            <select name="klasifikasi_jasa_id" id="klasifikasi_jasa_id_edit" required="" class="form-control select3" disabled>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Sub Klasifikasi<span hidden="hidden" class="js_e_mandatory" style="color: #E74C3C">*</span></label>
                                    <div class="col-sm-10">
                                        <div class="col-sm-14">
                                            <span class="lfc_alert"></span>
                                            <div class="row">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Kualifikasi<span hidden="hidden" class="js_e_mandatory" style="color: #E74C3C">*</span></label>
                                    <div class="col-sm-3">
                                        <label class="custom_select">
                                            <span class="lfc_alert"></span>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Sub Kualifikasi<span hidden="hidden" class="js_e_mandatory" style="color: #E74C3C">*</span></label>
                                    <div class="col-sm-3">
                                        <label class="custom_select">
                                            <span class="lfc_alert"></span>
                                ...
                                <div class="form-group">
                                    <label for="no" class="col-sm-2 control-label">No. Ijin<span hidden="hidden" class="js_e_mandatory" style="color: #E74C3C">*</span></label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="no_jasa_edit" name="no">
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label for="issued_by" class="col-sm-2 control-label">Dikeluarkan Oleh<span hidden="hidden" class="js_e_mandatory" style="color: #E74C3C">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control text-uppercase" id="issued_by_jasa_edit" name="issued_by">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="issued_date" class="col-sm-2 control-label">Berlaku Mulai<span hidden="hidden" class="js_e_mandatory" style="color: #E74C3C">*</span></label>
                                    <div class="col-sm-3">
                                        <div class="input-group date">
                                ...
                                <div class="form-group">
                                    <label for="expired_date" class="col-sm-2 control-label">Sampai<span hidden="hidden" class="js_e_mandatory" style="color: #E74C3C">*</span></label>
                                    <div class="col-sm-3 end">
                                        <div class="input-group date">
            ...
            <div class="content_spacer">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo form_open('Technical_document/do_insert_good',array('class' => 'form-horizontal insert_good', 'autocomplete'=>'off')); ?>
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'hidden') ?>">
                                <div class="panel-heading">Barang yang Bisa Dipasok</div>
                                <input type="text" class="hidden" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="no_barang" name="no">
                                        </div>
                                    </div>
                                     <div class="form-group">
                            ...
                            <?php echo form_open('Technical_document/do_insert_bahan',array('class' => 'form-horizontal insert_bahan', 'autocomplete'=>'off')); ?>
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'hidden') ?>">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="bahan_description" class="col-sm-3 control-label">Nama Bahan<span style="color: #E74C3C">*</span></label>
                                        <div class="col-sm-9"> 
                                        ...
                                        <div class="col-sm-3">
                                            <label for="bahan_source" class="custom_select">
                                                ...
                                                <select name="bahan_source" id="bahan_source" required="" class="form-control select2">
                                                    <option value="LOKAL">LOKAL</option>
                                                    <option value="IMPOER">IMPOER</option>
                                                </select>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label for="issued_by" class="col-sm-3 control-label mandatory_bahan">Dikeluarkan Oleh</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control text-uppercase" id="issued_by_bahan" name="issued_by_bahan">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="issued_date" class="col-sm-3 control-label mandatory_bahan">Berlaku Mulai</label>
                                        <div class="col-sm-3 end">
                                            <div class="input-group date">
                                    ...
                                    <div class="form-group">
                                        <label for="expired_date" class="col-sm-3 control-label mandatory_bahan">Sampai</label>
                                        <div class="col-sm-3 end">
                                            <div class="input-group date">
                            ...
                            <?php echo form_open('Technical_document/do_insert_service',array('class' => 'form-horizontal insert_service','autocomplete'=>'off')); ?>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <label class="custom_select">
                                                <span class="lfc_alert"></span>
                                                <select name="klasifikasi_jasa_id" id="klasifikasi_jasa_id" required="" class="form-control select2">
                                                    <option value="" selected="">Pilih Klasifikasi</option>
                                                </select>
                                            </label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="no" class="col-sm-2 control-label">No. Ijin<span hidden="hidden" class="js_mandatory" style="color: #E74C3C">*</span></label>
                                        <div class="col-sm-3">
                            ...
                            <?php echo form_close(); ?>
                            <table class="table table-hover margin-bottom-20 <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : '' ?>" id="services">
                                <thead>
                                    <tr>
                                        <th class="text-center">No</th>
                                    ...
                                    <?php else:
                                        ...
                                        foreach ($services as $key => $service) : ?>
                                            <tr id="<?php echo $service['PRODUCT_ID']; ?>">
                                                ...
                                                <td class="f_no">
                                                    <?php if (!empty($service['FILE_UPLOAD'])){ ?>
                                                        <a href="<?php echo base_url('Technical_document'); ?>/viewDok/<?php echo $service['FILE_UPLOAD']; ?>" class="previousfile" target="_blank" ><?php echo $service['NO']; ?></a>
                                                    <?php } else {  echo $service['NO']; } ?> 
                                                </td>
                            ...
                            ?>
                                <div class="panel panel-default">
                                    <div class="panel-body text-right">
                                        ...
                                        <a href="<?php echo base_url('Administrative_document/bank_and_financial_data') ?>" class="main_button color7 small_btn">Back</a>
                                        <button id="saveandcont_good_and_service" class="main_button color1 small_btn" type="button">Save & Continue</button>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
