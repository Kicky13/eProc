                                            ...
                                            <table id="tableMT" class="table table-striped nowrap" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center ts12"><a href="javascript:void(0)">Check</a></th>
                                                    </tr>
                                                    <tr class="sear">
                                        ...
                                        <table id="table_inv" class="table table-striped nowrap" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center ts4"><a href="javascript:void(0)">Base Amount</a></th>
                                                    <th class="text-center ts5"><a href="javascript:void(0)">Last Edit</a></th>
                                                    <th class="text-center ts6"><a href="javascript:void(0)">Status</a></th>
                                                    <th class="text-center ts7"><a href="javascript:void(0)">Posisi Dokumen</a></th>
                                                    <th class="text-center ts7"><a href="javascript:void(0)">Status Dokumen</a></th>
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12 col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" maxlength="20" onchange="setRequired(this,'fileKwitansi')" id="kwitansi_no" name="kwitansi_no" >
                            </div>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control"  maxlength="20" onchange="setRequired(this,'filePotMutu')" id="potmut_no" name="potmut_no" >
                            </div>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" maxlength="20" id="spbyr_no" name="spbyr_no"  onchange="setRequired(this,'filespbyr')" >
                            </div>
                            <div class="col-sm-3">
