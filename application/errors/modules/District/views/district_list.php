            ...
            <div class="content_spacer">
                <div class="content">
                    <div class="main_title centered upper">
                        <h2><span class="line"><i class="ico-users"></i></span>District Management</h2>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="panel panel-default"style='margin-left:3%;margin-right:3%;'>
                        ...
                        <div class="panel-body">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="toggleColumn-datatable">
                                ...
                                <tbody>
                                        <?php foreach ($district_list_data as $i) {?>
                                        
                                                <tr>
                                                    <td><?php echo $i['DISTRICT_CODE']?></td>
                                                    <td><?php echo $i['DISTRICT_NAME']?></td>
                                                    <td class="text-center">
                                                    <a class ="main_button small_btn edit_btn" href="#" data-toggle="tooltip" id="<?php echo $i['DISTRICT_ID']?>" title="Edit District" ><i class="in_left ico-dashboard2"></i></a>
                                                    <a class ="main_button small_btn del_btn" href="#" data-toggle="tooltip" id="<?php echo $i['DISTRICT_ID']?>" title="Delete District"><i class="in_left ico-dashboard2"></i></a>
                                                   </td>    
                                                </tr>
                                                <?php } ?>
                                </tbody>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
             <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="code_District">
            </div>
            <div class="form-group">
                    <label >District Name</label>
                    <input type="text" class="form-control" id="name_District">
            </div>
          </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
                    <label >District Code</label>
                    <input type="text" class="form-control" id="codeDistrict">
            </div>
            <div class="form-group">
                    <label >District Name</label>
                    <input type="text" class="form-control" id="nameDistrict" >
            </div>
          </div>
          <div class="modal-footer">
...
<div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Are You Sure To Delete District? </p> 
          </div>
          <div class="modal-footer">            
...
<script>
    $(document).ready(function(){
            ...
            $("#toggleColumn-datatable").on("click", ".edit_btn", function(e) {
                    e.preventDefault();
                    id_var = $(this).attr("id");
                    $('#codeDistrict').val($(this).parent().prev().prev().html());
                    $('#nameDistrict').val($(this).parent().prev().html());
            ...
            $("#saveAdd").click(function(e){
                $.ajax({
                    url: '<?php echo site_url(); ?>district/add',
                    type: 'GET',
                    data: {
             ...
             $("#editData").click(function(e){
                $.ajax({
                    url: '<?php echo site_url(); ?>district/edit',
                    type: 'GET',
                    data: {
                        "id_district": id_var,
                        "code_district": $('#codeDistrict').val(),
                        "name_district": $('#nameDistrict').val(),
                    },
                    success: function(results){
