...
<!--         <br>
        ...
        <div class="middle-left border kecilkan" style="vertical-align: top;text-align: left;width: 200px;height: 80;">
        	PERHATIAN: <br>
        	Dibalik halaman ini tercantum syarat-syarat yang merupakan bagian yang tidak terpisahkan dari Order Pembelian ini dan memiliki kekuatan hukum yang sama dengan perjanjian.
        </div>
    </div>
