                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body text-center">
                                <?php if ($is_approval == "true"): ?>
                                    <a type="button" class="main_button color7 small_btn close-modal" href="<?php echo base_url("Tender_winner_tonasa/listapprovalPO")?>">Kembali</a>
                                <?php else: ?>
                                    <a type="button" class="main_button color7 small_btn close-modal" href="javascript:window.close()">Tutup</a>
                                    <a type="button" class="main_button color7 small_btn close-modal" href="<?php echo base_url("Tender_winner_tonasa/detailPO/".($po_header['PO_ID'])."/false/true")?>">Print LP3</a>
