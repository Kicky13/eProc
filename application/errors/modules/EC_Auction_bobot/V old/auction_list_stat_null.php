									...
									<table class="table table-hover" id="negotiation_list">
										<thead>
											<tr>
												...
												<th class="text-left">Subject of Work</th>
										...
										<?php 
										 ...
										 ?>
											<tr style="border-bottom: 1px solid #ccc;">
												...
												<th class="text-center"><?php if($aunction[$i]['IS_ACTIVE']=='1') echo 'Aktif'; else echo '';?></th>	
												<th class="text-center"><a class="btn btn-info btn-xs" href="<?php echo base_url(); ?>EC_Auction/show_detail/<?php echo $aunction[$i]['NO_TENDER']?>">Process</a></th>	
											</tr>
										<?php } ?>
										</tbody>
									</table>
