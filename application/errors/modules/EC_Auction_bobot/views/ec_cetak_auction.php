...
<table style="width:100%;font-size: 12pt;" >
	...
	<tr>
		...
		<td>:</td>
		<td><?php echo $Detail_Auction['BOBOT_TEKNIS']; ?>% : <?php echo $Detail_Auction['BOBOT_HARGA']; ?>%</td>
	</tr>
	<tr>
		<td>Tipe Auction</td>
		<td>:</td>		
		...
		<td colspan="3">
			<table width="100%" border="0" cellspacing="0">
				<tr>
					...
					<th align="center" class="Kiri Bawah Atas Kanan">Kode Barang/Jasa</th>
					<th align="center" class="Kiri Bawah Atas Kanan">Nama Barang/Jasa</th>
					<th align="center" class="Kiri Bawah Atas Kanan">Kuantitas</th>
					<th align="center" class="Kiri Bawah Atas Kanan">UoM</th>
				</tr>
				<?php  $no = 1; foreach ($Itemlist as $item) { ?>
				<tr>
					<td align="center" class="Kiri Bawah Atas Kanan"><?php echo $no++.'.'; ?></td>
					<td align="center" class="Kiri Bawah Atas Kanan"><?php echo $item['KODE_BARANG']; ?></td>
					<td align="center" class="Kiri Bawah Atas Kanan"><?php echo $item['NAMA_BARANG']; ?></td>
					<td align="center" class="Kiri Bawah Atas Kanan"><?php echo $item['JUMLAH']; ?></td>
					<td align="center" class="Kiri Bawah Atas Kanan"><?php echo $item['UNIT']; ?></td>
				</tr>
				<?php } ?>
			</table>
		</td>
	...
	<tr>
		<td colspan="3">
			<table width="100%" border="0" cellspacing="0">
				<tr>
					<th align="center" class="Kiri Bawah Atas Kanan">No</th>
					<th align="left" class="Kiri Bawah Atas Kanan">Nama Vendor</th>
					<th align="center" class="Kiri Bawah Atas Kanan">Mata Uang</th>
					<th align="center" class="Kiri Bawah Atas Kanan">Harga</th>
					<th align="center" class="Kiri Bawah Atas Kanan">Nilai Total</th>
					<th align="center" class="Kiri Bawah Atas Kanan">Ranking</th>
				</tr>
				<?php $no = 1; foreach ($Peserta as $vnd) { ?>
				<tr>
					<td align="center" class="Kiri Bawah Atas Kanan"><?php echo $no.'.'; ?></td>
					<td align="left" class="Kiri Bawah Atas Kanan"><?php echo $vnd['NAMA_VENDOR']; ?></td>
					<td align="center" class="Kiri Bawah Atas Kanan"><?php echo $Detail_Auction['CURR']; ?></td>
					<td align="center" class="Kiri Bawah Atas Kanan"><?php echo number_format($vnd['HARGATERKINI']); ?></td>
					<td align="center" class="Kiri Bawah Atas Kanan"><?php echo number_format($vnd['NILAI_GABUNG'],2,".","."); ?></td>
					<td align="center" class="Kiri Bawah Atas Kanan"><?php echo $no++.''; ?></td>
				</tr>
				<?php } ?>
			</table>
	...
	<tr>
		<td colspan="3" class="Kiri Bawah Atas Kanan">
			Vendor yang mengundurkan diri sebagai berikut : <br>
	...
	<tr>
		<td colspan="3" height="50px" class="Kiri Bawah Atas Kanan"><?php echo $Detail_Auction['NOTE']; ?></td>
	</tr>
	<tr>
				...
				<tr>
					...
					<td style="padding-top:5px" >
						<table>
							...
							<tr>
								<td style="padding-left:20px;" valign="top">-</td>
								<td align="justify">Calon Pemenang adalah Nilai Total tertinggi hasil e-auction</td>
							</tr>
							<tr>
								<td style="padding-left:20px;" valign="top">-</td>
