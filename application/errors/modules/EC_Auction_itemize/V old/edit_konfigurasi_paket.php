                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td class="input-group date">                                   
                                    <input type="text" name="paqh_auc_start" class="form-control" value="<?php echo $paqh['PAQH_AUC_START'];?>"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                </td>
                            </tr>
                            <tr>
                                <td>Tanggal Penutupan</td>
                                <td class="input-group date">                                   
                                    <input type="text" name="paqh_auc_end" class="form-control" value="<?php echo $paqh['PAQH_AUC_END'];?>"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                </td>
                            </tr>
                            <tr>
                                <td>Nilai Pengurangan</td>
                                <td><input type="text" class="form-control must_autonumeric" name="paqh_decrement_value" placeholder="" value="<?php echo $paqh['PAQH_DECREMENT_VALUE']?>"></td>
                            </tr>
                            <tr>
                                <td>Tipe Auction</td>
                                <td>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="itemlist <?php echo $tit['PPI_ID'] ?>">
                                            ...
                                            <?php foreach ($vendors as $vnd){ ?>
                                                <?php if (isset($vendor_item[$tit['TIT_ID']][$vnd['PTV_VENDOR_CODE']])) { ?>
                                                    <td class="penawaran_vendor text-right <?php echo $vnd['PTV_VENDOR_CODE'] ?>"><?php echo $vendor_item[$tit['TIT_ID']][$vnd['PTV_VENDOR_CODE']]['PQI_PRICE'] ?></td>
                                        ...
                                        <tr class="trtotal">
                                            ...
                                            <?php foreach ($vendors as $vnd) {
                                                echo '<td class="text-center"><label><input type="checkbox" name="vendor_ikut['.$vnd['PTV_VENDOR_CODE'].']" value="'.$vnd['PTV_VENDOR_CODE'].'"></label></td>';
                                            }
                                            ?>
                                        </tr>
                                    </tbody>
