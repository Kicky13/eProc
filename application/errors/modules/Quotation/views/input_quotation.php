                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody id="itemtable">
                                            ...
                                            <tr id="tritem<?php echo $row['TIT_ID']; ?>" class="tritem">
                                                ...
                                                <td>
                                                    <?php if(!$viewSubmitted){ ?>
                                                        <textarea name="ptqi[<?php echo $row['TIT_ID'] ?>][pqi_description]" class="pqi_desc form-control pqi_description" maxlength="2000" required <?php echo $checked == ''? 'disabled' : '';?> ><?php echo $thispqi == null ? '' : $thispqi['PQI_DESCRIPTION'] ?></textarea>
                                                    <?php } else { ?>
