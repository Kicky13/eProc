                        ...
                        <div class="col-sm-2">
                            ...
                            if(!empty($invoice[0]['BAST_PIC'])){
                                    if(preg_match('/(\.jpg|\.png|\.pdf|\.jpeg)$/i',$invoice[0]['BAST_PIC'])){
                                      echo '<label class="control-label"><a href="'.base_url(UPLOAD_PATH) . '/EC_invoice/' . $invoice[0]['BAST_PIC'].'" target="_blank"><u>File Attachment</u></a></label>';
                                    }else{/*
                                      ...
                                      if(!empty($lot)){
                                        echo '
                                            <div class="link"><a href="#" data-nopo="'.$invoice[0]['NO_SP_PO'].'" data-tipe="RR" data-iddokumen="'.$lot[0]['LOT_NUMBER'].'" data-url="'.base_url('EC_Invoice_Management/showDocument').'" data-print_type="'.$lot[0]['PRINT_TYPE'].'" onclick="return showDocument(this)"><u>File Attachment</u></a></div>';
                                      }
                                    }
                                  } ?>
                        </div>
