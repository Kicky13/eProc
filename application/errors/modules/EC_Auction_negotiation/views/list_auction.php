										 ...
										 ?>
											<tr style="border-bottom: 1px solid #ccc;">
												...
												<th class="text-center">
													...
													<a class="btn btn-info btn-xs" href="<?php echo base_url(); ?>EC_Auction_negotiation/detail_auction/<?php echo $auction[$i]['NO_TENDER']?>">Process</a>
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
						  	...
						  	<li> <strong>KETENTUAN UMUM</strong>
						  		<ul style="margin-left: 40px;list-style-type: square;" >
									...
									<li>
										...
										peserta.</li>
									<li>
										Penurunan  harga  penawaran,  disarankan  tidak  kurang  dari  60  (enam  puluh)  detik  sebelum  
										closing, karena tidak dijamin oleh PT. Semen Indonesia (Persero) Tbk.</li>
									<li>
										Calon Pemenang adalah penawar terendah hasil print out berita acara e-auction</li>
									<li>
		      ...
		      <div class="modal-footer">
		      	...
		      	<p></p><br />
		      	<form method="post" action="<?php echo base_url(); ?>EC_Auction_negotiation/setuju" >
