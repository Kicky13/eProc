...
<section class="content_section">
	<div class="content_spacer">
		<div class="content">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="<?php echo base_url()?>EC_Auction/save" method="POST" class="submit">
					<input type="text" name="ptm_number" value="" hidden>
					<div class="panel panel-default">
						<div class="panel-heading" style="padding-bottom: 20px;">
							List Item
							<a type="button" href="<?php echo base_url(); ?>EC_Auction/resetItem" class="btn btn-danger btn-sm pull-right" aria-label="Left Align">
					...
					<div class="panel panel-default">
						<div class="panel-heading" style="padding-bottom: 20px;" >
							Peserta Auction
							<a type="button" href="<?php echo base_url(); ?>EC_Auction/resetPeserta"  class="btn btn-danger btn-sm pull-right">
								<span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
							</a>
							<a target="_blank" href="<?php echo base_url();?>EC_Auction/print_e_auction_peserta_temp/" type="button" style="margin-right: 20px" class="btn btn-default pull-right" aria-label="Left Align" >
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">        	 	
          <!-- <form class="form-horizontal" id="formUp" action="E_Catalog/upload/" method="post" enctype="multipart/form-data"> -->
          	<?php echo form_open_multipart('EC_Auction/updateItem/',array('method' => 'POST','id'=>'formUp','class' => 'form-horizontal')); ?>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">        	 	
          <!-- <form class="form-horizontal" id="formUp" action="E_Catalog/upload/" method="post" enctype="multipart/form-data"> -->
          	<?php echo form_open_multipart('EC_Auction/updateUser/',array('method' => 'POST','id'=>'formUp','class' => 'form-horizontal')); ?>
            	  <!-- <div class="col-md-12 hidden">
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="tbh-peserta" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form class="form-horizontal" action="<?php echo base_url()?>EC_Auction/addPeserta" method="POST">
		  <div class="form-group">
