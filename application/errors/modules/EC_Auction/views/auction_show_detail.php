                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="<?php echo base_url()?>EC_Auction/edit" method="post" > 
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                <form action="<?php echo base_url()?>EC_Auction/close" method="post" >
                                <input type="hidden" name="NO_TENDER" value="<?php echo $Detail_Auction['NO_TENDER'] ?>" />
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="padding-bottom: 20px;">
                            Log Auction 
                            <a target="_blank" href="<?php echo base_url();?>EC_Auction/print_e_auction_log/<?php echo $Detail_Auction['NO_TENDER']?>" type="button" style="margin-right: 20px" class="printt btn btn-default pull-right" aria-label="Left Align" >
                              <span class="glyphicon glyphicon-print" aria-hidden="true"></span>
                            </a>
                        </div>
                        <div class="panel-body">
