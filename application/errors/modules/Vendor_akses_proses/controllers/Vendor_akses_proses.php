...
class Vendor_akses_proses extends CI_Controller {
	...
	function get_data()
	{
		...
		$this->vendor_employe->join_adm_company();
		$datatable = $this->vendor_employe->get_ms(array('ID','EMP_NAME','NAME_LEVEL', 'COMPANYID','COMPANYNAME'));
