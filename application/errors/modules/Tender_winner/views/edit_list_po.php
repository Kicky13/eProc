                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data as $key => $value): ?>
                                        ...
                                        <?php foreach ( $value['item'] as $id => $val): ?>
                                            <?php if($id == 0): ?>
                                                <tr>
                                                    <td rowspan="<?php echo $value['nitem'] ?>"><a href="<?php echo base_url("Tender_winner/editReleasePO/".$value['PO_ID'])?>" target="_blank" title="Click - view - print PO"><?php echo $value['PO_NUMBER'] ?></a></td>
