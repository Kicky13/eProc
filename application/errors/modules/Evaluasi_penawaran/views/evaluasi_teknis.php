        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php endif ?>
                    <form method="post" id="form_assign" action="<?php echo base_url() ?>Evaluasi_penawaran/assign">
                    ...
                    <form name="quotation-form" id="quotation-form" method="post" action="<?php echo base_url() ?>Evaluasi_penawaran/save_bidding" class="submit" enctype="multipart/form-data">
                    <?php echo $evaluator ?>
                    <?php echo $detail_ptm ?>
