				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-12">
									...
									<table class="table table-hover">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-center"><a class="btn btn-default" href="<?php echo base_url(); ?>Penilaian_vendor/do_delete_penilaian_po/<?php echo $value["PERF_HIST_ID"]."/".$vendor_information['VENDOR_NO']; ?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
							...
							<?php echo form_open("Penilaian_vendor/do_insert_penilaian_po",array('class' => 'form-horizontal')); ?>
