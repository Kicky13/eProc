...
class Monitoring_pr extends CI_Controller {
	...
	public function index() {
		...
		$this->layout->add_js('pages/monitoring_pr.js');
	...
	public function get_datatable($isnottor = true) {
		...
		foreach ($data1 as $line){
			...
			$data_tbl['PPR_DATE_RELEASE'] 	= betteroracledate(oraclestrtotime($line['PPR_DATE_RELEASE']));
