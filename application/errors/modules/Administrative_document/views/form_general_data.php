                    ...
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    echo form_dropdown('cabang', $cabang, '', 'class="form-control select2"'); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="country" class="col-sm-6 control-label">Negara<span style="color: #E74C3C">*</span></label>
                                                <div class="col-sm-6">
                                                    <select name="country" class="form-control select2" id="country_select" name="country">
                                                        <option></option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <?php
                                                    echo form_dropdown('province', $province, '', 'id="province" class="form-control select2" disabled'); ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group" id="city_wrapper">
                                                <label for="city" class="col-sm-6 control-label">Kota<span style="color: #E74C3C">*</span></label>
                                                <div class="col-sm-6">
                                                    <select id="city_select" class="form-control city_select select2" disabled name="city_select">
                                                    </select>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover margin-bottom-20 <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : '' ?>" id="company_address">
                                    <thead>
                                        <tr>
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'hidden') ?>">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="contact_phone_no" class="col-sm-6 control-label">No. HP<span style="color: #E74C3C">*</span></label>
                                                <div class="col-sm-6">
