<section class="content_section">
    <div class="content_spacer">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form id="auction-form" action="<?php echo base_url()?>Auction/save" method="POST" class="submit">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td class="input-group date">
                                    <input type="text" name="paqh_auc_start" class="auc_start form-control"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                </td>
                            </tr>
                            <tr>
                                <td>Tanggal Penutupan</td>
                                <td class="input-group date">
                                    <input type="text" name="paqh_auc_end" class="auc_end form-control"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                </td>
                            </tr>
                            <tr>
                                <td>Nilai Pengurangan</td>
                                <td><input type="text" class="decrement_value form-control must_autonumeric" name="paqh_decrement_value" placeholder=""></td>
                            </tr>
                            <tr>
                                <td>Tipe Auction</td>
                                <td>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <?php foreach ($vendors as $vnd) { ?>
                                                <th class="text-center" colspan="2" title="<?php echo $vnd['PTV_VENDOR_CODE']?>"><?php echo $vnd['VENDOR_NAME']?></th>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body text-center">
                            ...
                            <button id="submit_button" type="button" class="main_button color6 small_btn tombolsimpan">Simpan</button>
                        </div>
                    </div>
                    </form>
                </div>
