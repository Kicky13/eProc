...
class prc_tender_main_user extends CI_Model {
	...
	public function join_pr_req($is_jasa = false) {
		...
		$this->db->join('PRC_PURCHASE_REQUISITION', 'SUBSTR(PRC_TENDER_ITEM.PPI_ID , 0, 10) = PRC_PURCHASE_REQUISITION.PPR_PRNO', 'left', null);
