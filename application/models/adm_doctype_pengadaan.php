...
class adm_doctype_pengadaan extends CI_Model {
	...
	public function where_cat_in($val){
		$this->db->where_in('CAT',$val);
	}

	public function find($id,$prgp=null) {
		$retval = $this->get(array("$this->table.$this->id" => $id, "$this->table.$this->prgp" => $prgp));
