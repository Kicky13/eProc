<?php
class user_vendor_auction_itemize extends CI_Model
{
	function __construct()
	{
		parent::__construct();
        $this->db = $this->load->database('default', TRUE);
        $this->table = 'EC_AUCTION_ITEMIZE_PESERTA';
	$this->table_header = 'EC_AUCTION_ITEMIZE_HEADER';        
	...
	public function getUser($username, $password)
	{
		...
		$result = $this->db->query("select * from EC_AUCTION_ITEMIZE_HEADER a
left join EC_AUCTION_ITEMIZE_PESERTA b on a.NO_TENDER = b.ID_HEADER
where a.is_active = 2 and b.USERID = '$username' and b.PASS = '$password'");
