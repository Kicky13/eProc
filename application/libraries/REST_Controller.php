...
const HTTP_NETWORK_AUTHENTICATION_REQUIRED = 511;
    ...
    */
    ...
    public function __construct($config = 'rest')
    {
        ...
        $rest_database_group = config_item('rest_database_group');
        $rest_enable_keys = config_item('rest_enable_keys');
        $rest_enable_logging = config_item('rest_enable_logging');
        $rest_database_group = config_item('rest_database_group');
        if ($rest_database_group and ($rest_enable_keys or $rest_enable_logging)) {
            $this->rest->db     = $this->load->database($rest_database_group, true);
        }
