                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default tombolmonitor">
                        <div class="panel-body text-center">
                            ...
                            <?php if($paqh['IS_BREAKDOWN']==0){ ?>
                            <a href="<?php echo base_url(); ?>Auction/index/proses" class="main_button color7 small_btn back-btn">Kembali</a>
                            <?php if($paqh['BREAKDOWN_TYPE']=='S'){?>
                            <a href="<?php echo base_url(); ?>Auction_negotiation/breakdown/<?php echo url_encode($paqh['PAQH_ID'])?>" class="main_button color5 small_btn">Breakdown Sendiri</a>
                            <?php } }else{?>
                            <a href="<?php echo base_url(); ?>Auction/index/history" class="main_button color7 small_btn back-btn">Kembali</a>
                            <?php }?>
