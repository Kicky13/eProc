                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            <table id="tableMT" class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center ts5"><a href="javascript:void(0)">Tipe</a></th>
                                    <th class="text-center ts6"><a href="javascript:void(0)">Status Assign</a></th>
                                    <th class="text-center ts7"><a href="javascript:void(0)">Kategori</a></th>
                                    <th class="text-center ts8"><a href="javascript:void(0)">Assign Kategori</a></th>
                                </tr>
                                <tr>
                                    <th></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="MATNR"
                           class="col-sm-2 control-label"><?php echo $baseLanguage ['strategic_material_no']; ?></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="MAKTX"
                           class="col-sm-2 control-label"><?php echo $baseLanguage ['strategic_material_shrt_txt']; ?></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="MATKL"
                           class="col-sm-2 control-label"><?php echo $baseLanguage ['strategic_material_group']; ?></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="MTART"
                           class="col-sm-2 control-label"><?php echo $baseLanguage ['strategic_material_type']; ?></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="created"
                           class="col-sm-2 control-label"><?php echo $baseLanguage ['strategic_material_created']; ?></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="lastChg"
                           class="col-sm-2 control-label"><?php echo $baseLanguage ['strategic_material_lastchg']; ?></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-offset-3 col-sm-9">
                        <img id="pic" class="thumbnail zoom"
                             onerror="this.onerror=null;this.src='<?php echo base_url(UPLOAD_PATH) . '/EC_material_strategis/default_post_img.png'; ?>'"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-offset-3 col-sm-9">
                        <p class="help-block">
                            <small><?php echo $baseLanguage ['ecat_file']; ?></small>
                        </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-4 col-sm-8">
                        <button type="submit" id="uploadButton"
                                class="btn btn-primary"><?php echo $baseLanguage ['principal_manufacturer_save']; ?></button>
                    </div>
                </div>
                </form>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title text-center"><u>Pilih Kategori Material
                        <!-- <?php //echo $baseLanguage ['principal_manufacturer_addTtl'] ; ?> --></u></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            <label for="CODE_M" class="col-sm-3 control-label">Kode Material
                                <!-- <?php //echo $baseLanguage ['principal_manufacturer_name'] ; ?> --></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="nama_material" class="col-sm-3 control-label">Nama Material
                                <!-- <?php //echo $baseLanguage ['principal_manufacturer_code'] ; ?> --></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="Category" class="col-sm-3 control-label">Nama Kategori
                                <!-- <?php //echo $baseLanguage ['principal_manufacturer_name'] ; ?> --></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="CODE_Category" class="col-sm-3 control-label">Kode Kategori
                                <!-- <?php //echo $baseLanguage ['principal_manufacturer_name'] ; ?> --></label>
                            <div class="col-sm-9">
