...
class Batal_pengadaan extends CI_Controller {
	...
	public function index() {
		...
		$this->layout->add_js('pages/list_hapus_pengadaan.js');
		$this->layout->render('hapus_pengadaan_list', $data);
	}
	...
	public function detail($id){
		...
		$data['title'] = 'Persetujuan Release Complete';
		$data['ptm_number'] = $id;
		...
		$this->layout->set_table_js();
		$this->layout->set_table_cs();			
		$this->layout->render('detail_hapus_pengadaan',$data);
	}
	...
	public function submit(){
		...
		$prc_tender_main = $this->prc_tender_main->ptm($id)[0];
		$ptm['PTM_STATUS'] = $prc_tender_main['PTM_STATUS'] * - 1;

		$this->session->set_flashdata('success', 'success'); redirect('Hapus_pengadaan');
	}
}
