                        ...
                        <div class="panel-group" id="accordionperbarui" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-default">
                                ...
                                <div id="collapsePerbarui" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                    <div class="panel-body">
                                        <form method="post" action="<?php echo base_url() ?>Doc_po/listPO/" novalidate>
                                        ...
                                        <?php foreach ($data as $key => $value): ?>
                                            <?php if(isset($value['item'])): ?>
                                                <?php foreach ( $value['item'] as $id => $val): ?>
                                                    <?php if($id == 0): ?>
                                                        <tr>
                                                            <td rowspan="<?php echo $value['nitem'] ?>">
                                                                <a title="Monitoring Procurement" href="<?php echo base_url("Tender_winner/editReleasePO/".$value['PO_ID'])?>" class="btn btn-default btn-sm glyphicon glyphicon-pencil"></a>
                                                            </td>
