<section class="content_section">
    <div class="content_spacer">
        <div class="content">
            ...
            <form id="quoform" method="post" action="<?php echo base_url() ?>Quotation_vendor/save_bidding" enctype="multipart/form-data" class="submit">
                ...
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <td class="col-md-9">
                                        <div class="row">
                                            ...
                                            ?>
                                                ...
                                                <a href="<?php echo base_url('Quotation_vendor'); ?>/viewDok/<?php echo $pqm['FILE_SURAT']; ?>" class="previousfile" target="_blank" >
                                                    File Exist
                                                </a>
                                            ...
                                            <div class="row" >
                                                ...
                                                <div class="col-md-4" id="dvshowme_<?php echo $jam?>">
                                                    <?php if ($pqm_id != null && !empty($pqm['PQM_FILE_'.strtoupper($jam)])): ?>
                                                        ...
                                                        <a href="<?php echo base_url('Quotation_vendor'); ?>/viewDok/<?php echo $pqm['PQM_FILE_'.strtoupper($jam)] ?>" class="previousfile" target="_blank" >
                                                            File Exist
                                                        </a>
                                                        <a href="#!" onclick="deletefile(this)" class="previousfile"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                                    <?php endif ?>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if(!empty($pef[$tit['TIT_ID']])) : ?>
                                                        ...
                                                        <div class="col-sm-8" id="fileView">
                                                            <a href="<?php echo base_url('Quotation_vendor'); ?>/viewDok/<?php echo $pef[$tit['TIT_ID']]; ?>" target="_blank" >File Exist</a> 
                                                            <?php if(!$viewSubmitted): ?>
                        ...
                        <?php if($ptv[0]['PTV_TENDER_TYPE']==1 && $ptv[0]['PTV_APPROVAL']==1 && $pqm_id != null){?>
                            <div class="well well-sm text-center">
                                <a href="<?php echo base_url('Quotation_vendor') ?>" class="main_button color7 small_btn">Kembali</a>
                                &nbsp;&nbsp;Penawaran sudah di Approve Principal
                            </div>
                        <?php }else { ?>
                            <div class="well well-sm text-center">
                            <?php if($ptv[0]['PTV_TENDER_TYPE']==1){?>
                                <?php if(!$viewSubmitted){ ?>
                                    <a href="<?php echo base_url('Quotation_vendor') ?>" class="main_button color7 small_btn">Kembali</a>
                                    <button type="submit" id="save_bidding" class="main_button color6 small_btn">Simpan Penawaran</button>
                                <?php } else {?>
                                    <a href="<?php echo base_url('Quotation_vendor') ?>/view_submittedQuotation" class="main_button color7 small_btn">Kembali</a>
                                <?php }?>
                            <?php }else { ?>
                                <?php if(!$viewSubmitted){ ?>
                                    <a href="<?php echo base_url('Quotation_vendor') ?>" class="main_button color7 small_btn">Kembali</a>
                                    &nbsp;&nbsp;Penawaran By Principal
                                <?php } else {?>
                                    <a href="<?php echo base_url('Quotation_vendor') ?>/view_submittedQuotation" class="main_button color7 small_btn">Kembali</a>
                                <?php }?>
                            <?php }?>
