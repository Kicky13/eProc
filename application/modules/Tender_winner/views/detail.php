                        ...
                        <div class="panel panel-default">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-10">
                                        <input name="DOC_ANALISA_HARGA" id="DOC_ANALISA_HARGA" accept="application/msword, application/pdf" type="file">
                                    </td>                            
                                </tr>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            // if (!isset($itemtext[$item['PTW_ID']])) {
                                                ...
                                                // <textarea name="itemtext['.$item['PTW_ID'].']" class="col-md-12" placeholder="Item Text">'.$return_sap[$key].'</textarea>
                                                // </td>';
                                                            ?>
                                                            <td>

                                                                <!-- Trigger the modal with a button -->
                                                                <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal<?php echo $item['PTW_ID']; ?>">Isi Item Text</button>

                                                                <!-- Modal -->
                                                                <div id="myModal<?php echo $item['PTW_ID']; ?>" class="modal fade" role="dialog">
                                                                  <div class="modal-dialog modal-lg">
                                                                    ...
                                                                    <div class="modal-content">
                                                                      <div class="modal-header">
                                                                        ...
                                                                        <h4 class="modal-title"><?php echo $item['PPI_NOMAT'].' '.$item['PPI_DECMAT'];?></h4>
                                                                    </div>
                                                    ...
                                                    <?php
                                                // echo '<td>'.$this->ckeditor->editor('itemtext['.$item['PTW_ID'].']','').'</td>';
                                            // } else {
                                                // echo '
                                                // <td>
                                                //     <textarea name="itemtext['.$item['PTW_ID'].']" class="col-md-12" placeholder="Item Text">'.(isset($itemtext[$item['PTW_ID']])?$itemtext[$item['PTW_ID']]:'').'</textarea>
                                                // </td>';
                                            ...
                                            // }
                                                    ...
                                                    //echo '<td>'.number_format(intval($item['TIT_QUANTITY'])*intval($item['PQI_PRICE'])).'</td>';
