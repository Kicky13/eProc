                    ...
                    <div class="row">
                        <div class="panel-body">
                            ...
                            <table>
                                ...
                                <table>
                                    <tr>
                                        <td class="col-md-3"><strong>Nama Pengadaan</strong></td>
                                    ...
                                    <tr>
                                        <td class="col-md-3"><strong>Dokument analisa kewajaran harga</strong></td>
                                        <td>: 
                                            <?php
                                            if(!empty($po_header['DOC_ANALISA_HARGA'])){
                                                ?>
                                                <a href="<?php echo base_url()?>upload/temp/<?php echo $po_header['DOC_ANALISA_HARGA'];?>">ATTACHMENT</a>
                                                <?php
                                            } else {
                                    ...
                                    <tr>
                                        <td class="col-md-3"><strong>Hasil Evaluasi</strong></td>
                                        <td>: 
                                            <a href="<?php echo base_url('Export_pdf'); ?>/evaluasi_teknis/<?php echo $ptm['PTM_NUMBER']; ?>" target="_blank" title='print'><span class="glyphicon glyphicon-print"></a>
                                        </td>
                                    </tr>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td class="col-md-2"><strong>Jangka Waktu</strong></td>
                                        <td class="col-md-1 text-right">:</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-md-1 text-right">:</td>
                                        <!-- <td><?php echo html_entity_decode(nl2br(str_replace('  ', '&nbsp;&nbsp;&nbsp;', $po_header['HEADER_TEXT']))) ?></td> -->
                                        <!-- <td><?php echo html_entity_decode((str_replace('  ', '&nbsp;&nbsp;&nbsp;', $po_header['HEADER_TEXT']))) ?></td> -->
                                        <td><?php echo html_entity_decode($po_header['HEADER_TEXT']) ?></td>
                                    </tr>
                                </table>
                                <br>
                                <div class="col-md-12" style="margin-bottom: 2%">
                ...
                <?php if($is_print=='false'): ?>
                    <div class="col-md-12">
                        <div class="col-md-12">
                            ...
                            <!-- rekap nego dari halaman negosiasi -->
