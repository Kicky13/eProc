                                ...
                                <div id="clps" class="panel-collapse collapse in">
                                    <div class="table-responsive">
                                        <table class="table table-hover table-bordered">
                                            <thead>
                                                <th class="col-md-2 text-center"><strong>No</strong></th>
                                                <th class="col-md-2 text-center"><strong>Doc</strong></th>
                                            </thead>
                                            <tbody class="table_evaluasi_harga">
                                                <?php
                                                if(count($doc_nego)>0){
                                                    $i=1;
                                                    foreach ($doc_nego as $dn) {
                                                        if(!empty($dn['DOC_NEGO'])){
                                                            ?>
                                                            <tr>
                                                                <td><?php echo $i;$i++; ?></td>
                                                                <td>                                            
                                                                    <a target="_blank" href="<?php echo base_url() ?>upload/doc_nego/<?php echo $dn['DOC_NEGO']; ?>"> <span class="glyphicon glyphicon-file"></span> <?php echo $dn['DOC_NEGO']; ?> </a>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                        }
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td colspan="2">Tidak ada dokumen</td>
                                                    </tr>
                                                    <?php
                                                }
