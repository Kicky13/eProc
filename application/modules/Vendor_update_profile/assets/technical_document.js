		...
		$.ajax({
			...
			success:function(data){
				$.each(data, function(i,product){
					...
					$('.uploadAttachment.md_barang').show();
			        if(product.FILE_UPLOAD != null){
			        	$('.uploadAttachment.md_barang').hide();
			        }
		...
		$.ajax({
			...
			success:function(data){
				$.each(data, function(i,product){
					...
					$('.uploadAttachment.md_jasa').show();
			        if(product.FILE_UPLOAD != null){
			        	$('.uploadAttachment.md_jasa').hide();
			        }
		...
		$.ajax({
			...
			success:function(data){
				$.each(data, function(i,product){
					...
					$('.uploadAttachment.md_bahan').show();
			        if(product.FILE_UPLOAD != null){
			        	$('.uploadAttachment.md_bahan').hide();
			        }
...
// UPLOAD FILE
    $('.uploadAttachment').each(function(event) {
        ...
        }  else if (panel == 'up_good_e') {
			var	progressOuter = $('.progress-striped.p_good_e'),
        		progressBar = $('.progress-bar.b_good_e');
        } else if (panel == 'up_bahan') {
			var	progressOuter = $('.progress-striped.p_bahan'),
        		progressBar = $('.progress-bar.b_bahan');
        } else if (panel == 'up_bahan_e') {
			var	progressOuter = $('.progress-striped.p_bahan_e'),
        		progressBar = $('.progress-bar.b_bahan_e');
        } else if (panel == 'up_jasa') {
        	var	progressOuter = $('.progress-striped.p_jasa'),
        		progressBar = $('.progress-bar.b_jasa');
        } else if (panel == 'up_jasa_e') {
        	var	progressOuter = $('.progress-striped.p_jasa_e'),
        		progressBar = $('.progress-bar.b_jasa_e');
        ...
        }else if (panel == 'up_peng_p') {
        	var	progressOuter = $('.progress-striped.p_peng_p'),
        		progressBar = $('.progress-bar.b_peng_p');
        };
