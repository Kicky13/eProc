                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel <?php if (!isset($progress_status[$container])) { echo 'panel-default'; } else if ($progress_status[$container]['STATUS'] == 'Rejected') { echo 'panel-danger'; } else if ($progress_status[$container]['STATUS'] == 'Edited') {  echo 'panel-warning'; } else { echo 'panel-success'; } ?>">
                                ...
                                <div class="panel-body">
                                    <input type="text" class="hidden" disabled="disabled" name="vendor_id" id="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if ($vendor_detail["ADDRESS_COUNTRY"] == '') { ?>
                                            <input type="text" class="form-control" id="address_country" disabled="disabled" name="address_country" >
                                        <? } else { ?>
                            ...
                            <div class="panel <?php if (!isset($progress_status[$container])) { echo 'panel-default'; } else if ($progress_status[$container]['STATUS'] == 'Rejected') { echo 'panel-danger'; } else if ($progress_status[$container]['STATUS'] == 'Edited') {  echo 'panel-warning'; } else { echo 'panel-success'; } ?>">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <?php if ($vendor_detail["NPWP_PKP"] == '') { ?>
                                                <input type="text" class="form-control" id="npwp_pkp" disabled="disabled" name="npwp_pkp" >
                                            <? } else { ?>
        ...
        <script type="text/javascript">
            ...
            $('#finish_registration_button').on( "click", function() {
                var cm = $('#comment').val();
                var dm = $('#vendor_id').val();
                // alert(cm);

                $.ajax({
                    url : 'cek_panel_reject',
                    method : 'post',
                    data : "vendor_id="+dm,
                    success : function(result)
                    {
                        url = 'data_vendor';
                        if (result!=0){
                            alert('Mohon perbaiki data yang telah direvisi !');
                        } else {
                            $.ajax({
