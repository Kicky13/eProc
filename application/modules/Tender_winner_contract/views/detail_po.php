...
<form id="form_po_approval" name="form_po_approval" action="<?php echo base_url()?>Tender_winner_contract/approve" method="POST">
                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body text-center">
                                <a type="button" class="main_button color2 small_btn btn-edit" href="<?php echo base_url("Tender_winner_contract/detail/".($po_header['PO_ID']))?>" title="Dikembalikan ke Form LP3">Edit</a>
                                <a type="button" class="main_button color5 small_btn btn-renego" href="<?php echo base_url("Tender_winner_contract/renego/".($po_header['PO_ID']))?>" title="Dikembalikan ke Tahap Negosiasi">Renegosiasi</a>
                                <a type="button" class="main_button color4 small_btn btn-retender" href="<?php echo base_url("Tender_winner_contract/retender/".($po_header['PO_ID']))?>" title="Dilakukan Tender ulang">Retender</a>
                                <a type="button" class="main_button color3 small_btn btn-cancel" href="<?php echo base_url("Tender_winner_contract/cancel/".($po_header['PO_ID']))?>" title="Pembatalan (cancel) tender secara permanen">Batal</a>
                            </div>
                        </div>
                        <?php endif ?>
                        <div class="panel panel-default">
                            <div class="panel-body text-center">
                                <?php if ($is_approval == "true"): ?>
                                    <a type="button" class="main_button color7 small_btn close-modal" href="<?php echo base_url("Tender_winner_contract/listapprovalPO")?>">Kembali</a>
                                <?php else: ?>
                                    <a type="button" class="main_button color7 small_btn close-modal" href="javascript:window.close()">Tutup</a>
                                    <a type="button" class="main_button color7 small_btn close-modal" href="<?php echo base_url("Tender_winner_contract/detailPO/".($po_header['PO_ID'])."/false/true")?>">Print LP3</a>
