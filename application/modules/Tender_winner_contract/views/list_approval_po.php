                        ...
                        <div class="panel-group" id="accordionperbarui" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-default">
                                ...
                                <div id="collapsePerbarui" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                    <div class="panel-body">
                                        <form method="post" action="<?php echo base_url() ?>Tender_winner_contract/listapprovalPO" novalidate>
                                        ...
                                        <?php $no = 1; foreach ($value['item'] as $val): ?>
                                            <?php if($no == 1): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center" rowspan="<?php echo $value['nitem'] ?>"><a href="<?php echo base_url("Tender_winner_contract/detailPO/".$poid."/true") ?>" class="btn btn-default col-md-12 <?php echo $state?'':'hidden';?>"><i class="glyphicon glyphicon-search"></i></a></td>
...
<div id="comment_modal" class="modal" role="dialog">
  <div class="modal-dialog">
    <form name="form_list_approve" id="form_list_approve" action="<?php echo base_url()?>Tender_winner_contract/approve" method="POST">
