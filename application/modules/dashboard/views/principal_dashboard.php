							...
							<table class="table">
								...
								<tbody>
									<tr>
										...
										<td class="text-center"><strong><a href="<?php echo site_url('Tender_invitation_principal'); ?>"><?php echo $total_tender_invitation; ?></a></strong></td>
										<td>Negosiasi</td>
										<td class="text-center"><strong><a href="<?php echo base_url('Nego_invitation_principal') ?>"><?php echo $total_negotiaion ?></a></strong></td>
									</tr>
									<tr>
										<td>Input/Edit Penawaran</td>
										<td class="text-center"><strong><a href="<?php echo site_url('Quotation_principal'); ?>"><?php echo $total_quotation ?></a></strong></td>
										<td>Auction</td>
									...
									<tr>
										...
										<td class="text-center"><strong><a href="<?php echo site_url('Quotation_principal'); ?>/view_submittedQuotation"><?php echo $total_submit_quotation ?></a></strong></td>
										<td></td>
