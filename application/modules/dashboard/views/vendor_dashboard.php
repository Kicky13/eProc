		...
		<div class="content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<?php endif ?>
					<h6 style="display: none;"><a href="<?php echo site_url('D_dashboard_new'); ?>">Dashboard Vendor New</a></h6> 
						...
						<div class="panel-body">
							<table class="table">
								...
								<tbody>
									...
									<tr>
										<td>Klarifikasi teknis dan Harga</td>
										<td class="text-center"><strong><a href="<?php echo site_url('Proc_chat_vendor'); ?>/index"><?php echo $tot_chat ?></a></strong></td>
										<td>Contract</td>
										<td class="text-center"><strong><a href="<?php echo site_url('Tender_awarded_contract'); ?>"><?php echo $total_tender_awarded_contract; ?></a></strong></td>
										<?php
										if($showInvoice){
											echo '<tr>';
											echo '<td>Invoice</td>';
											...
											echo '<td>Penawaran Pembelian Langsung</td>';
											echo '<td class="text-center"><strong><a href="'.site_url('EC_Penawaran_Vendor').'/index">'.$penawaran.'</a></strong></td>';
											echo '</tr>';
											echo '<tr>';
											echo '<td></td><td></td>';
											echo '<td>PO Pembelian Langsung</td>';
											echo '<td class="text-center"><strong><a href="'.site_url('EC_Shipment').'/index">'.$open_po.'</a></strong></td>';
											echo '</tr>';
										} else {
											echo '<tr>';
											echo '<td>Penawaran Pembelian Langsung</td>';
											echo '<td class="text-center"><strong><a href="'.site_url('EC_Penawaran_Vendor').'/index">'.$penawaran.'</a></strong></td>';
											echo '<td>Pembelian Langsung</td>';
											echo '<td class="text-center"><strong><a href="'.site_url('EC_Shipment').'/index">'.$open_po.'</a></strong></td>';
											echo '</tr>';
										}
										?>
									...
									<tr>
										...
										<td>SPB</td>
										<td class="text-center"><strong><a href="<?php echo site_url('Tender_awarded_spb'); ?>"><?php echo $po_spb; ?></a></strong></td>
									</tr>
