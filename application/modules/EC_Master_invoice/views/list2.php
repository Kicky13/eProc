            ...
            <div class="row">
                ...
                <div class="row">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"><a class="tab13" href="#TambahPlant" aria-controls="TambahPlant" role="tab" data-toggle="tab">Plant</a></li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="TambahPlant">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="border-bottom: 1px solid #ccc; border-right: 1px solid #ccc; border-left: 1px solid #ccc;">
                                <div class="panel-group skrol" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div class="row" style="border-bottom: 1px solid #ccc;">                                                                                
                                        <br>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <table id="tableMT" class="table table-striped nowrap" width="100%">
                                            <thead>
                                                <tr>
                                                    <th class="text-center ts0"><strong>Role As</strong></th>
                                                    <th class="text-center ts1"><strong>Value</strong></th>
                                                    <th class="text-center ts2"><strong>Edit</strong></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php for ($i = 0; $i < sizeof($tambahPlant); $i++) {
                                                    ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $tambahPlant[$i]['ROLE_AS'] ?></td>
                                                        <td class="text-center"><?php echo $tambahPlant[$i]['VALUE'] ?></td>
                                                        <td class="text-center"><a href="javascript:void(0)" data-toggle="modal" data-target="#editPlantBaru" data-role="<?php echo $tambahPlant[$i]['ROLE_AS'] ?>" data-nilai="<?php echo $tambahPlant[$i]['VALUE'];?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
                                                    </tr>
                                                    <?php }
                                                ?>
                                            </tbody>
...
<div class="modal fade" id="editPlantBaru">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title text-center"><strong><u>Edit Plant</u></strong></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-11 col-md-offset-1">
                        <form class="form-horizontal" action="<?php echo base_url() ?>EC_Master_invoice/EditPlantBaru" method="post">
                            <div class="form-group">                                
                                <label for="input" class="col-sm-3 control-label">ROLE AS</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="ROLE_AS" required="" id="ROLE_AS" placeholder="" readonly="">
                                </div>
                            </div>
                            <div class="form-group">                                
                                <label for="input" class="col-sm-3 control-label">VALUE</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="VALUE" required="" id="VALUE" placeholder="VALUE">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
