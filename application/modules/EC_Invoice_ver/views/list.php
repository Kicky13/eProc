                                    ...
                                    <table id="table_inv" class="table table-striped nowrap" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center ts4"><a href="javascript:void(0)">Tipe PO</a></th>
                                                <th class="text-center ts5"><a href="javascript:void(0)">Vendor</a></th>
                                                <th class="text-center ts6"><a href="javascript:void(0)">No. Invoice</a></th>
                                                <th class="text-center ts7"><a href="javascript:void(0)">Faktur Pajak</a></th>
                                                <th class="text-center ts8"><a href="javascript:void(0)">Total Amount</a></th>
                                                <th class="text-center ts9"><a href="javascript:void(0)">Tanggal</a></th>                                                
