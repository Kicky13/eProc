		...
		<div class="content" style="margin-left: 10px;margin-right: 10px">
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 pull-right">
					...
					<a href="javascript:void(0)" style="box-shadow: 1px 1px 1px #ccc; display: none;"  data-toggle="modal" data-target="#modalbudget" type="button" class="btn btn-default"><span class="" aria-hidden="true">IDR</span>&nbsp;<span class="budget">Loading...</span></a>
					<button type="submit"  style="display: none"  class="btn btn-default">
						Histori
					</button>
					<a href="<?php echo base_url(); ?>EC_Ecatalog/checkout" style="box-shadow: 1px 1px 1px #ccc" type="button" class="btn btn-default" onclick="openChart()"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Cart &nbsp;<span class="badge jml"></span></a>
...
<!--								<option value="0">No-Price</option>-->
								<option value="3">Pembelian Langsung</option>
							</select>
						</div>
					</div>
					<div class="row" style="margin-right: -5px;padding-left: 10px">
						...
						<div class="col-lg-12" style="overflow-y: auto; background-color: white;box-shadow: 1px 1px 1px 1px #ccc; max-height: 100vh;">
							<ul id="tree1">

							</ul>
						</div>
						<div class="col-lg-12">
							<div class="row" style="display: none; background-color: white;border-top: 5px solid #ccc;box-shadow: 1px 1px 1px 1px #ccc;border-bottom: 1px solid #ccc;border-right: 1px solid #ccc; margin-top: 10px;">
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="form-group">
						<label for="picure" class="col-sm-2 control-label">Picture</label>
