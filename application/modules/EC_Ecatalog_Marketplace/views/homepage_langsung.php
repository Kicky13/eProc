    	...
    	<div class="content">
	    	...
	    	<div class="row">
		        ...
		        <div class="col-sm-10 col-md-10 col-lg-10">
		          <form method="post" action="<?php echo base_url(); ?>EC_Ecatalog_Marketplace/listCatalogLsgs" >
	    					...
	    					if($kategori[$i]['KODE_PARENT']==0){
							    ...
							    <div class="panel-heading" role="tab" id="headingThree">
							      <h4 class="panel-title">
							        <a href="'.base_url().'EC_Ecatalog_Marketplace/listCatalogLsgs/'.$kategori[$i]['KODE_USER'].'" onclick="getCategory(\''.$kategori[$i]['KODE_USER'].'\')" style="font-size:'.$size.'px">
							      ...
							      <div class="panel-body">
							        ...
							        for($j=0;$j<sizeof($kategori);$j++){
							        	if($kategori[$i]['ID_CAT']==$kategori[$j]['KODE_PARENT']){
							        		echo '<a href="'.base_url().'EC_Ecatalog_Marketplace/listCatalogLsgs/'.$kategori[$j]['KODE_USER'].'" onclick="getCategory(\''.$kategori[$j]['KODE_USER'].'\')" class="list-group-item size-list-item">'.$kategori[$j]['DESC'].'</a>';	
							        	}							        	
							        }	
									echo '</div>
							      </div>
