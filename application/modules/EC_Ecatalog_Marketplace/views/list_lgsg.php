...
<!--                    <a href="javascript:void(0)" style="box-shadow: 1px 1px 1px #ccc;" data-toggle="modal" data-target="#modalbudget"
                    ...
                    <!-- <a href="<?php //echo base_url(); ?>EC_Ecatalog_Marketplace/checkout_lgsg" style="box-shadow: 1px 1px 1px #ccc" type="button"
                       class="btn btn-default" onclick="openChart()">
                    ...
                    <a href="<?php echo base_url(); ?>EC_Ecatalog_Marketplace/checkout" style="box-shadow: 1px 1px 1px #ccc" type="button"
                       class="btn btn-default" onclick="">
                        <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Cart &nbsp;
                        <span class="badge jml">0</span>
                    </a>
                    <!-- <button  -->
                    <!-- <a href="<?php //echo base_url(); ?>EC_Ecatalog_Marketplace/perbandingan_pl" style="box-shadow: 1px 1px 1px #ccc" type="button"
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="row" style="margin-bottom: 20px;margin-right: -5px; display: none;">
                        <div class="col-md-offset-2 col-lg-offset-2 col-lg-8 col-md-8">
                            <select id="listmode" class="form-control" style="width: 190px;">
                                <option value="1">Pembelian Kontrak</option>
                    ...
                    <div class="row" style="margin-right: -5px;padding-left: 10px">
                        ...
                        <div class="col-lg-12"
                             style="overflow-y: auto; background-color: white;box-shadow: 1px 1px 1px 1px #ccc; max-height: 100vh;">
                            <ul id="tree1">
                        ...
                        <div class="col-lg-12">
                            <div class="row"
                                 style="display: none; background-color: white;border-top: 5px solid #ccc;box-shadow: 1px 1px 1px 1px #ccc;border-bottom: 1px solid #ccc;border-right: 1px solid #ccc; margin-top: 10px;">
                                <div class="col-lg-12" style="margin-left: 15px">
                                    ...
                                    <button type="button" class="btn btn-default" id="btnTampilkan" style="margin-top: 5px;">
                                        Tampilkan
                                    </button>
                                    <p></p>
                                </div>
                ...
                <div class="col-lg-9 col-md-9">
                    <div class="row" style="margin-bottom: 5px">
                        ...
                        <div class="col-lg-2">
                            <div class="btn-group pull-right">
                                <button type="button" id="thlist" style="box-shadow: 1px 1px 1px #ccc" onclick="modeList('list')"
                                        class="btn btn-default " title="Model Tampilan List" aria-label="Left Align">
                                    <span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
                                </button>
                                <button type="button pull-right" style="box-shadow: 1px 1px 1px #ccc" onclick="modeList('grid')" disabled 
                                        id="gridlist" class="btn btn-default" title="Model Tampilan Grid" aria-label="Left Align">
                    ...
                    <div class="row">
                        <div id="divAttributes" class="container"
                             style="background-color: white;box-shadow: 1px 1px 1px #ccc; margin-bottom: 5px; border:2px solid #ccc; border-top: solid 10px #ccc;">
...
<!--                </table>-->
                <!--                <div class="input-group">-->
                <!--                    <div class="input-group-addon"><small>CostCenter</small></div>-->
                <!--                    <input type="text" class="form-control" value="-->
<!--                --><?php //echo var_dump($ccc['COSTCENTER']);?>
                ...
                <form class="form-inline" action="<?php echo base_url(); ?>EC_Ecatalog_Marketplace/simpanCC" method="post">
                    ...
                    <input type="hidden" name="nameCC" id="nameCC" value="<?php echo $ccc["COSTCENTER"]; ?>:<?php echo $ccc["CC_NAME"]; ?>">
                    <div class="form-group">
