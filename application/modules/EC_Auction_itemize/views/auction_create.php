		...
		<div class="content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<form action="<?php echo base_url()?>EC_Auction_itemize/importExcel" method="POST" enctype="multipart/form-data" class="submit">
						<input type="text" name="ptm_number" value="" hidden>
						<div class="panel panel-default">
							<div class="panel-heading" style="padding-bottom: 20px;">
								List Item
								<a type="button" href="<?php echo base_url(); ?>EC_Auction_itemize/resetItem" class="btn btn-danger btn-sm pull-right" aria-label="Left Align">
								...
								<div class="">
									...
									<div>
										<label class="col-sm-1 control-label" style="margin: 6px;width: auto;">
											...
											<a href="<?php echo base_url(); ?>upload/format_excel_item.xlsx">disini</a>
										</label>
									</div>
					...
					<div class="panel panel-default">
						<form action="<?php echo base_url(); ?>EC_Auction_itemize/resetPeserta">
							<div class="panel-heading" style="padding-bottom: 20px;" >
								List Peserta Auction
								<button type="submit" class="btn btn-danger btn-sm pull-right">
									<span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
								</button>
								<a target="_blank" href="<?php echo base_url();?>EC_Auction_itemize/print_e_auction_peserta_temp/" type="button" style="margin-right: 20px" class="btn btn-default pull-right" aria-label="Left Align" >
									<span class="glyphicon glyphicon-print" aria-hidden="true"></span>
								</a>
								<a style="margin-right: 20px" class="btn btn-warning btn-sm pull-right btn-hasilawal" data-toggle="tooltip" title="View/Edit">Hasil</a>
								<!-- <button style="margin-right: 20px" type="button" class="btn btn-success btn-sm pull-right" data-toggle="modal" onclick="showOlehRanking()">
									hasil
								</button> -->
									...
									<table class="table tablee table-hover" >
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a class="btn btn-info btn-sm btn-hargaawal" data-id="<?php echo $value['KODE_VENDOR']?>" data-toggle="tooltip" title="View/Edit">Lihat Harga
														<!-- <i class="fa fa-pencil-square-o" aria-hidden="true"></i> -->
													</a>
												</td>
												<?php } else { ?>
												<td>
													<a href="<?php echo base_url()?>EC_Auction_itemize/export?KODE_VENDOR=<?php echo $value['KODE_VENDOR']?>" target="_blank" class="main_button color6 small_btn" id="idexcell" data-toggle="tooltip" title="Export Excel"><span class="glyphicon glyphicon-download-alt"></span></a>
				...
				<!-- <div class="row">
					<div class="col-md-12">
						...
						<div class="panel-body" id="hasilawal">
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="padding-bottom: 20px;">
					List Batch
					<a type="button" href="<?php echo base_url(); ?>EC_Auction_itemize/resetBatch" class="btn btn-danger btn-sm pull-right" aria-label="Left Align">
						<span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
					</a>
					<?php if($sisa>0){ ?>
				...
				<div class="panel panel-default">
					...
					<table class="table table-hover">
						...
						<tr>
							<td>Unit Peminta</td>
							<td>
								<select class="form-control" name="opco">
									<?php
									foreach ($company as $cp) {
										echo "<option value=".$cp['COMPANYID'].">".$cp['COMPANYID']." - ".$cp['COMPANYNAME']."</option>";
									} 
									?>
								</select>
							</td>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" id="tbh-hargaawal" role="dialog" aria-labelledby="myLargeModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="gridSystemModalLabel">Set Harga Awal</h4>
			</div>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" id="upload-harga" role="dialog" aria-labelledby="myLargeModalLabel">
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" action="<?php echo base_url()?>EC_Auction_itemize/do_upload" enctype="multipart/form-data" method="POST">
...
<!-- <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="hasilall" aria-labelledby="myLargeModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="tbh-batch" aria-labelledby="myLargeModalLabel">
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" action="<?php echo base_url()?>EC_Auction_itemize/addBatch1" method="POST">
					<div class="form-group">
