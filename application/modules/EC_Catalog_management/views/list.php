              ...
              <table id="tableMT" class="table table-striped nowrap" width="100%">
                <thead>
                  <tr>
                    ...
                    <th class="text-center ts0"><a href="javascript:void(0)">Action</a></th>
                    <th class="text-center ts2"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_no']; ?></a></th>
                    <th class="text-center ts3"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_itm']; ?></a></th>
                    <th class="text-center ts4"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_doc']; ?></a></a></th>
                    <th class="text-center ts5"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_vndno']; ?></a></th>
                    <th class="text-center ts6"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_vndname']; ?></th>
                    <th class="text-center ts7"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_valdtsr']; ?></th>
                    <th class="text-center ts8"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_valdten']; ?></th>
                    <th class="text-center ts9"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_matno']; ?></th>
                    <th class="text-center ts10"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_shrt']; ?></th>
                    <th class="text-center ts11"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_matg']; ?></th>
                    <th class="text-center ts12"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_prog']; ?></th>
                    <th class="text-center ts13"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_prgp']; ?></th>
                    <th class="text-center ts14"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_plnt']; ?></th>
                    <th class="text-center ts15"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_qty']; ?></th>
                    <th class="text-center ts16"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_uom']; ?></th>
                    <th class="text-center ts17"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_nprc']; ?></th>
                    <th class="text-center ts18"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_per']; ?></th>
                    <th class="text-center ts19"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_grpr']; ?></th>
                    <th class="text-center ts20"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_curr']; ?></th>
                    <th class="text-center ts21"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_ah']; ?></th>                     
                    <th class="text-center ts22"><a href="javascript:void(0)">Category</th>
                  </tr>
                  <tr id="sear">
                    <th> </th>
                    <th><center>Publish All:   <input type="checkbox" id="checkAll"></center> </th>
