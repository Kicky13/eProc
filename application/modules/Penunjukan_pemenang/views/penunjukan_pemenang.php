                                    ...
                                    <table class="table table-hover">
                                        <?php if($ptp['PTP_IS_ITEMIZE']==1):?>
                                            ...
                                            <?php foreach ($pqiall[$tit['TIT_ID']] as $pqi): ?>
                                                <?php
                                                $val = $vendor_data[$pqi['PTV_VENDOR_CODE']]; 
                                                $harga = $pqi['PQI_PRICE'];
                                                if ($pqi['PQI_FINAL_PRICE'] != 0){
                                                    $harga = $pqi['PQI_FINAL_PRICE'];
                                                }
                                                ?>
                                                <tr>
                                                    ...
                                                    <?php $price_status = $harga > $tit['TIT_PRICE'] ? 'danger' : ($pqi['FINALWIN'] == $val['PTV_VENDOR_CODE'] ? 'info' : '') ?>
                                                    <td class="col-md-2 text-right <?php echo $price_status; ?>">
                                                        <span class="winprice hidden"><?php echo $harga ?></span>
                                                        <span class=""><?php echo number_format($harga); ?></span>
                                                    </td>
                                                    <td class="col-md-2 text-right">
                                                        <span class=""><?php echo number_format($pqi['PQI_QTY']*$harga) ?></span>
                                        ...
                                        <?php if($ptp['PTP_IS_ITEMIZE']=='0'):?>
                                            ...
                                            foreach ($vendor_data as $val1){
                                                ...
                                                foreach ($tits as $tit1){
                                                    ...
                                                    $harga = $pqi1['PQI_PRICE'];
                                                    if ($pqi1['PQI_FINAL_PRICE'] != 0){
                                                        $harga = $pqi1['PQI_FINAL_PRICE'];
                                                    }
