        <section class="content_section">
                        ...
                        <div class="modal-body">
                            <?php echo form_open('Vendor_update_profile/do_insert_akta_pendirian',array('class' => 'form-horizontal current_edited_akta')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="colm-sm-6">
                                        <input type="text" id="pengesahan_hakim_doc" class="hidden" name="pengesahan_hakim_doc">
                                        <button type="button" required class="uploadAttachment btn btn-default">Upload File (2MB Max)</button><span class="filenamespan"></span>
                                        <div class="progress progress-striped active" style="margin: 10px 0px 0px; display: none;">
                                            <div class="progress-bar progress-bar-success"  role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 0%"></div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="colm-sm-6">
                                        <input type="text" id="berita_acara_ngr_doc" class="hidden" name="berita_acara_ngr_doc">
                                        <button type="button" required class="uploadAttachment btn btn-default">Upload File (2MB Max)</button><span class="filenamespan"></span>
                                        <div class="progress progress-striped active" style="margin: 10px 0px 0px; display: none;">
                                            <div class="progress-bar progress-bar-success"  role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 0%"></div>
                                        </div>
            ...
            <div class="content_spacer">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo form_open('Administrative_document/do_insert_akta_pendirian',array('class' => 'form-horizontal insert_akta', 'autocomplete'=>'off')); ?>
                                ...
                                <table class="table table-hover margin-bottom-20 <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : '' ?>" id="vendor_akta">
                                    ...
                                    <tbody id="tableItem">
                                        ...
                                        <tr id="<?php echo $akta['AKTA_ID']; ?>">
                                            ...
                                            <td class="text-center"><?php if (!empty($akta['AKTA_NO_DOC'])){ ?><a target="_blank" href="<?php echo base_url('Administrative_document') ?>/viewDok/<?php echo $akta['AKTA_NO_DOC']; ?>"><?php echo $akta['AKTA_NO']; ?></a><?php } else {echo $akta['AKTA_NO']; } ?></td>
                                            ...
                                            <td class="text-center"><?php if (!empty($akta['PENGESAHAN_HAKIM_DOC'])){ ?><a target="_blank" href="<?php echo base_url('Administrative_document') ?>/viewDok/<?php echo $akta['PENGESAHAN_HAKIM_DOC']; ?>"><?php echo vendorfromdate($akta['PENGESAHAN_HAKIM']); ?></a><?php } else {  echo vendorfromdate($akta['PENGESAHAN_HAKIM']); }?></td>
                                            <td class="text-center"><?php if (!empty($akta['BERITA_ACARA_NGR_DOC'])){ ?><a target="_blank" href="<?php echo base_url('Administrative_document') ?>/viewDok/<?php echo $akta['BERITA_ACARA_NGR_DOC']; ?>"><?php echo vendorfromdate($akta['BERITA_ACARA_NGR']); ?></a><?php } else { echo vendorfromdate($akta['BERITA_ACARA_NGR']); }?></td>
                        ...
                        <?php echo form_open('Administrative_document/do_update_legal_data',array('class' => 'form-horizontal legal_form legal_form_all domisili')); ?>
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'hidden') ?>">
                                ...
                                <div class="panel-body collapse" id="domisili_perusahaan">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control lgl" id="address_domisili_no" name="address_domisili_no" value="<?php echo set_value('address_domisili_no', $vendor_detail["ADDRESS_DOMISILI_NO"]); ?>">
                                            <span id="dom1"></span>
                                        </div>
                                        <div class="colm-sm-6">
                                            ...
                                            if (!empty($vendor_detail["DOMISILI_NO_DOC"])) { ?>
                                                <span class="messageUpload"><a style="color: #666; text-decoration: underline" href="<?php echo base_url('Administrative_document')."/viewDok/".$vendor_detail["DOMISILI_NO_DOC"]; ?>" title="File Attachment" target="_blank">File Attachment</a>&nbsp;&nbsp;<a class="btn btn-default delete_upload_doc glyphicon glyphicon-trash"></a></span>&nbsp;&nbsp;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3 end">
                                            <div class="input-group date">
                                                <input type="text" id="address_domisili_exp_date" name="address_domisili_exp_date" class="form-control" value="<?php echo set_value('address_domisili_exp_date', vendorfromdate($vendor_detail["ADDRESS_DOMISILI_EXP_DATE"])); ?>" readonly=""><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                                <span id="dom3"></span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <?php echo form_open('Administrative_document/do_update_legal_data',array('class' => 'form-horizontal legal_form legal_form_all npwp')); ?>
                            <?php $container = 'NPWP'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'hidden') ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="colm-sm-6">
                                            ...
                                            if (!empty($vendor_detail["NPWP_NO_DOC"])) { ?>
                                                <span class="messageUpload"><a style="color: #666; text-decoration: underline" href="<?php echo base_url('Administrative_document')."/viewDok/".$vendor_detail["NPWP_NO_DOC"]; ?>" title="File Attachment" target="_blank">File Attachment</a>&nbsp;&nbsp;<a class="btn btn-default delete_upload_doc glyphicon glyphicon-trash"></a></span>&nbsp;&nbsp;
                                            <?php
                                            }
                                            else { ?>
                                                <span class="messageUpload" style="display:none"></span>&nbsp;&nbsp;
                        ...
                        <?php echo form_open('Administrative_document/do_update_legal_data',array('class' => 'form-horizontal legal_form_pkp legal_form_all')); ?>
                            <?php $container = 'PKP'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'hidden') ?>">
                                ...
                                <div class="panel-body collapse" id="pkp">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control text-uppercase" id="npwp_pkp_no" name="npwp_pkp_no" value="<?php echo set_value('npwp_pkp_no', $vendor_detail["NPWP_PKP_NO"]); ?>">
                                        ...
                                        <div class="colm-sm-4">
                                            ...
                                            if (!empty($vendor_detail["PKP_NO_DOC"])) { ?>
                                                <span class="messageUpload"><a style="color: #666; text-decoration: underline" href="<?php echo base_url('Administrative_document')."/viewDok/".$vendor_detail["PKP_NO_DOC"]; ?>" title="File Attachment" target="_blank">File Attachment</a>&nbsp;&nbsp;<a class="btn btn-default delete_upload_doc glyphicon glyphicon-trash"></a></span>&nbsp;&nbsp;
                                            <?php
                                            }
                                            else { ?>
                                                <span class="messageUpload" style="display:none"></span>&nbsp;&nbsp;
                        ...
                        <?php echo form_open('Administrative_document/do_update_legal_data',array('class' => 'form-horizontal legal_form legal_form_all siup')); ?>
                            <?php $container = 'SIUP'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'hidden') ?>">
                                ...
                                <div class="panel-body collapse" id="siup">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="colm-sm-4">
                                            ...
                                            if (!empty($vendor_detail["SIUP_NO_DOC"])) { ?>
                                                <span class="messageUpload"><a style="color: #666; text-decoration: underline" href="<?php echo base_url('Administrative_document')."/viewDok/".$vendor_detail["SIUP_NO_DOC"]; ?>" title="File Attachment" target="_blank">File Attachment</a>&nbsp;&nbsp;<a class="btn btn-default delete_upload_doc glyphicon glyphicon-trash"></a></span>&nbsp;&nbsp;
                                            <?php
                                            }
                                            else { ?>
                                                <span class="messageUpload" style="display:none"></span>&nbsp;&nbsp;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group date">
                                                <input type="text" name="siup_from" id="siup_from" class="form-control" value="<?php echo set_value('siup_from', vendorfromdate($vendor_detail["SIUP_FROM"])); ?>" value="<?php echo set_value('siup_from', $vendor_detail["SIUP_FROM"]); ?>" readonly=""><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                            </div>
                                                <span id="siup4"></span>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group date">
                                                <input type="text" name="siup_to" id="siup_to" class="form-control" value="<?php echo set_value('siup_to', vendorfromdate($vendor_detail["SIUP_TO"])); ?>" value="<?php echo set_value('siup_to', $vendor_detail["SIUP_TO"]); ?>" readonly=""><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                            </div>
                                                <span id="siup5"></span>
                                        </div>
                                    </div>
                        ...
                        <?php echo form_open('Administrative_document/do_update_legal_data',array('class' => 'form-horizontal legal_form legal_form_all tdp')); ?>
                            <?php $container = 'TDP'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'hidden') ?>">
                                ...
                                <div class="panel-body collapse" id="tdp">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="colm-sm-4">
                                            ...
                                            if (!empty($vendor_detail["TDP_NO_DOC"])) { ?>
                                                <span class="messageUpload"><a style="color: #666; text-decoration: underline" href="<?php echo base_url('Administrative_document')."/viewDok/".$vendor_detail["TDP_NO_DOC"]; ?>" title="File Attachment" target="_blank">File Attachment</a>&nbsp;&nbsp;<a class="btn btn-default delete_upload_doc glyphicon glyphicon-trash"></a></span>&nbsp;&nbsp;
                                            <?php
                                            }
                                            else { ?>
                                                <span class="messageUpload" style="display:none"></span>&nbsp;&nbsp;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group date">
                                                <input type="text" id="tdp_from" name="tdp_from" class="form-control" value="<?php echo set_value('tdp_from', vendorfromdate($vendor_detail["TDP_FROM"])); ?>" value="<?php echo set_value('tdp_from', $vendor_detail["TDP_FROM"]); ?>" readonly=""><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                                <span id="tdp3"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group date">
                                                <input type="text" id="tdp_to" name="tdp_to" class="form-control" value="<?php echo set_value('tdp_to', vendorfromdate($vendor_detail["TDP_TO"])); ?>" value="<?php echo set_value('tdp_to', $vendor_detail["TDP_TO"]); ?>" readonly=""><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                            </div>
                                                <span id="tdp4"></span>
                                        </div>
                                    </div>
                        ...
                        <?php echo form_open('Administrative_document/do_update_legal_data',array('class' => 'form-horizontal legal_form legal_form_all api')); ?>
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'hidden') ?>">
                                ...
                                <div class="panel-body collapse" id="api">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="colm-sm-4">
                                            <input type="text" id="api_no_doc" class="namafile hidden" name="api_no_doc" value="<?php echo set_value('api_no_doc', $vendor_detail["API_NO_DOC"]); ?>">
                                            <?php
                                            if (!empty($vendor_detail["API_NO_DOC"])) { ?>
                                                <span class="messageUpload"><a style="color: #666; text-decoration: underline" href="<?php echo base_url('Administrative_document')."/viewDok/".$vendor_detail["API_NO_DOC"]; ?>" title="File Attachment" target="_blank">File Attachment</a>&nbsp;&nbsp;<a class="btn btn-default delete_upload_doc glyphicon glyphicon-trash"></a></span>&nbsp;&nbsp;
                                            <?php
                                            }
                                            else { ?>
                                                <span class="messageUpload" style="display:none"></span>&nbsp;&nbsp;
                                            ...
                                            ?>
                                            <input type="text" class="hidden" id="attachment_1" name="attachment_1" value="">
                                            <?php if (!empty($vendor_detail["API_NO_DOC"])) { ?>
                                                <button type="button" required class="uploadAttachment btn btn-default" data-uploaded="true">Change File (2MB Max)</button>
                                            <?php
                                            }
                                            else { ?>
                                                <button type="button" required class="uploadAttachment upload_api btn btn-default">Upload File (2MB Max)</button>
                                            <?php }
                                            ?>
                                            <div class="progress progress-striped active" style="margin: 10px 0px 0px; display: none;">
                                                <div class="progress-bar progress-bar-success"  role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 0%"></div>
                            ...
                            <?php if($this->session->userdata('STATUS')=='99' || $this->session->userdata('needupdate')==true){?>
                                <div class="panel panel-default">
                                    <div class="panel-body text-right">
                                        <a href="<?php echo base_url(); ?>Additional_document/input_summary" class="main_button small_btn">Back</a>
                                        <button id="save_new_legal" class="main_button color1 small_btn" type="button">Save</button>
                                    </div>
                                </div>
                            <?php 
                            } else {
                            ?>
                                <div class="panel panel-default">
                                    <div class="panel-body text-right">
                                        ...
                                        <a href="<?php echo base_url('Administrative_document/general_data') ?>" class="main_button color7 small_btn">Back</a>
                                        <button id="save_new_legal" class="main_button small_btn" type="button">Save</button>
                                        <button id="saveandcont_legal" class="main_button color1 small_btn" type="button">Save & Continue</button>
                                    </div>
                                </div>
                            <?php } ?>
