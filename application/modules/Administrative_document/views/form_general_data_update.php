                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open('Administrative_document/do_update_general_address',array('class' => 'form-horizontal current_edited_address')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" rows="3" name="alamat" id="alamat_edit" value="<?php echo set_value('company_name', $vendor_detail["ADDRESS_STREET"]); ?>" style="resize: vertical"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group" id="city_wrapper">
                                            ...
                                            <div class="col-sm-6">
                                                <?php  echo form_dropdown('city', $city, '', 'id="city_select_edit" class="form-control city_select"');?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="postcode_edit" name="postcode" value="<?php echo set_value('postcode', $vendor_detail["ADDRESS_POSTCODE"]); ?>">
                                    </div>
                                    <label for="website" class="col-sm-3 control-label">Website</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="website_edit" name="website" value="<?php echo set_value('website'); ?>">
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                ...
                                <div class="panel-body">
                                    <?php if(isset($progress_status[$container]) && $progress_status[$container]['STATUS'] == 'Rejected'):?>
                                        <div class="form-group">
                                            <label for="material_code" class="col-sm-3 control-label">Reason</label>
                                            <div class="col-sm-9">
                                                <textarea disabled class="col-sm-12"><?php echo $progress_status[$container]['REASON']; ?></textarea>
                                            </div>
                                        </div>
                                        <hr>
                                    <?php endif ?>
                                	...
                                	<div class="form-group">
                                		...
                                		<div class="col-sm-9">
                                			<input type="text" class="form-control" id="company_name" name="company_name" value="<?php echo set_value('company_name', $vendor_detail["VENDOR_NAME"]); ?>">
                                		</div>
                                	</div>
                                	<div class="form-group">
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="alamat" class="col-sm-3 control-label">Alamat<span style="color: #E74C3C">*</span></label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="3" name="alamat" id="alamat" style="resize: vertical"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label id="province_mandatory" for="province" class="col-sm-6 control-label">Provinsi</label>
                                                <div class="col-sm-6">
                                                    <?php
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group" id="city_wrapper">
                                                <label for="city" class="col-sm-6 control-label">Kota<span style="color: #E74C3C">*</span></label>
                                                <div class="col-sm-6">
                                                    <select id="city_select" class="form-control city_select" disabled name="city_select" required>
                                                    </select>
                                                    <input type="text" class="form-control hidden" id="city" name="city" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="postcode" class="col-sm-6 control-label">Kode Pos<span style="color: #E74C3C">*</span></label>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="website" class="col-sm-6 control-label">Website</label>
                                                <div class="col-sm-6">
                            ...
                            <table class="table table-hover margin-bottom-20" id="company_address">
                                ...
                                <tbody id="tableItem">
                                    ...
                                    <tr id="<?php echo $address['ADDRESS_ID']; ?>">
                                        ...
                                        <td><?php echo ucwords(strtolower($address['CITY'])); ?></td>
                                        <td><?php echo $country_list[$address['COUNTRY']]; ?></td>
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="contact_name" name="contact_name" value="<?php echo set_value('contact_name', $vendor_detail["CONTACT_NAME"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="contact_pos" class="col-sm-3 control-label">Jabatan<span style="color: #E74C3C">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="contact_pos" name="contact_pos" value="<?php echo set_value('contact_pos', $vendor_detail["CONTACT_POS"]); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="contact_email" name="contact_email" value="<?php echo set_value('contact_email', $vendor_detail["CONTACT_EMAIL"]); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body text-right">
                                    ...
                                    <button id="saveandcont" class="main_button color1 small_btn" type="button">Save & Continue</button>
                                </div>
                            </div>
                        </div>
                    </div>
