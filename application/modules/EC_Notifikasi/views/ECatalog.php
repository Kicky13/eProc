...
<head>
    ...
    <style type="text/css">
        ...
        .tanpa-border td{border-style:none;}
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-style:solid;">
    ...
    <tr>
        <td class="topContainer" style="padding-left:5px; padding-right:5px; background-color:#E74C3C;">
            ...
            <table class="row" width="750" bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" border="0" style="border-style:solid; text-align:left; border-spacing:0; max-width:100%; width:900px;margin:0 auto;">
                <tr>
                    <td class="oneFromTwo" width="50%" valign="middle" style="border-bottom:1px dotted #dddddd">
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-style:solid; border-spacing:0;">
                            <tr>
    ...
    <tr>
        <td class="container" style="padding-left:5px; padding-right:5px; padding-bottom:20px; background-color:#e9e9e9;">
            ...
            <table class="row" width="750" bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" border="0" style="border-style:900px; text-align:left; border-spacing:0; max-width:100%; width:900px;margin:0 auto;">
                <tr>
            ...
            <!-- Start of footer -->
            <table class="row" width="750" bgcolor="#f4f4f4" align="center" cellpadding="0" cellspacing="0" border="0" style="border-style:solid; text-align:left; border-spacing:0; max-width:100%; width:900px;margin:0 auto;">
                <tr>
