        ...
        <td class="container" style="padding-left:5px; padding-right:5px; padding-bottom:20px; background-color:#e9e9e9;">
            ...
            <table class="row" width="750" bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; text-align:left; border-spacing:0; max-width:100%; margin:0 auto;">
                <tr>
                    <td style="padding-top:25px; padding-left:30px; padding-right:30px; padding-bottom:20px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777;">
                       <b>User : <?php echo $detail[0]['EMAIL']; ?></b><br>
                    </td>
                </tr>
            </table>
            <table class="row" width="750" bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" border="1" style="border-collapse:collapse; text-align:left; border-spacing:0; max-width:100%; margin:0 auto;">
                <tr>
                    ...
                    <td align="center">Usulan Pratender</td>
                    <td align="center">Pratender</td>
                    <td align="center">Deskripsi</td>
                    <td align="center">PGRP</td>
                    <td align="center">Status</td>
                    <td align="center">Tanggal Aktivitas</td>
                </tr>
                <?php $no=1; foreach ($detail as $val): ?>
                <tr>
                    <td align="center"><?php echo $no++; ?></td>
                    <td align="center"><?php echo $val['PTM_SUBPRATENDER']; ?></td>
                    <td align="center"><?php echo $val['PTM_PRATENDER']; ?></td>
                    <td><?php echo $val['PTM_SUBJECT_OF_WORK']; ?></td>
                    <td align="center"><?php echo $val['PTM_PGRP']; ?></td>
                    <td><?php echo $val['PROCESS_NAME']; ?></td>
                    <td><?php echo $val['PTC_END_DATE']; ?></td>
                </tr>
                <?php endforeach; ?>
            </table>
            <table bgcolor="#ffffff" align="center" width="750" >
                 <tr>
                    <td style="padding-left:30px; padding-right:30px; padding-bottom:32px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:15pt; color:#777777; text-align:center;">
                        <a class="main_button " target="_self" href="https://int-eprocurement.semenindonesia.com/eproc/Login" style="-moz-border-radius:3px; -webkit-border-radius:3px; -ms-border-radius:3px; -o-border-radius:3px; border-radius:3px; line-height:normal; margin-top:20px; background:#E74C3C; border:1px solid #E74C3C; color:#fff !important; padding:11px 14px; font-size:13px; display:inline-block; text-decoration: none;">
                            Proses
                        </a>
                    </td>
                </tr>
