<section class="content_section">
    <div class="content_spacer">
        <div class="content">
            ...
            <form id="quoform" method="post" action="<?php echo base_url() ?>Quotation/save_bidding" enctype="multipart/form-data" class="submit">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <table class="table table-hover">
                                <tr>
                                    <td class=" col-md-3">Surat Penawaran</td>
                                    <td class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <?php if(!$viewSubmitted){ ?>
                                                    <input type="text" name="pqm_number" class="form-control" id="pqm_number" value="<?php echo $pqm_id == null ? '' : $pqm['PQM_NUMBER'] ?>" Placeholder="Nomor Surat Penawaran" required>
                                                <?php } else { ?>
                                                    <input type="text" name="pqm_number" class="form-control" id="pqm_number" value="<?php echo $pqm_id == null ? '' : $pqm['PQM_NUMBER'] ?>" Placeholder="Nomor Surat Penawaran" disabled>
                                                <?php } ?>
                                            </div>
                                            <div class="col-md-4">
                                            <?php  
                                            ...
                                            <?php } ?>
                                            <?php if(!$viewSubmitted){ ?>
                                                <input type="file" class="form-control inputfile" name="file_surat" id="file_surat" required>
                                                <span class="text-warning">*Mohon upload Surat Penawaran</span>
                                            <?php } else { ?>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody id="itemtable">
                                            ...
                                            <tr id="tritem<?php echo $row['TIT_ID']; ?>" class="tritem">
                                                ...
                                                <td>
                                                    <?php if(!$viewSubmitted){ ?>
                                                        <textarea maxlength="2000" name="ptqi[<?php echo $row['TIT_ID'] ?>][pqi_description]" class="pqi_desc form-control pqi_description" maxlength="2000" required <?php echo $checked == ''? 'disabled' : '';?> placeholder="* Dimohon untuk mengisi SPESIFIKASI LENGKAP" ><?php echo $thispqi == null ? '' : $thispqi['PQI_DESCRIPTION'] ?></textarea>
                                                    <?php } else { ?>
                                                        <textarea name="ptqi[<?php echo $row['TIT_ID'] ?>][pqi_description]" class="pqi_desc form-control pqi_description" maxlength="2000" disabled <?php echo $checked == ''? 'disabled' : '';?> placeholder="* Dimohon untuk mengisi SPESIFIKASI LENGKAP"><?php echo $thispqi == null ? '' : $thispqi['PQI_DESCRIPTION'] ?></textarea>
                                                    <?php } ?>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php else :
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="hidden" required="" name="file_upload[]" class="file_upload">  
                                                                <button type="button" required="" class="quotation_uploadAttachment btn btn-default jasa">Upload File (4MB Max)</button><span class="filenamespan"></span>
