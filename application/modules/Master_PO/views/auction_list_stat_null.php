									...
									<table class="table table-hover" id="negotiation_list">
										<thead>
											<tr>
                                                ...
                                                <th class="text-left">Jumlah Batch</th>
										...
										<?php 
										 ...
										 ?>
											<tr style="border-bottom: 1px solid #ccc;">
                                                ...
                                                <th class="text-left"><?php echo $aunction[$i]['HITUNG_BATCH']?> Batch</th>
												<th class="text-center <?php if($aunction[$i]['ACTIVE_NEW']=='1') echo 'success'; else echo 'danger';?>"><?php if($aunction[$i]['ACTIVE_NEW']=='1') echo 'ACTIVE'; else echo 'CLOSED';?></th>	
