							...
							<form action="<?php echo base_url()?>EC_Auction_itemize/edit" method="post" > 
								...
								<div class="row">
									<div class="col-md-12">
										...
										&nbsp;
										<a target="_blank" href="<?php echo base_url();?>EC_Auction_itemize/print_e_auction_peserta_detail/<?php echo $Detail_Auction['NO_TENDER']; ?>" type="button" style="margin-top: 15px" class="btn btn-default pull-left" aria-label="Left Align" >
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="padding-bottom: 20px;">
								Log Auction 
								<a id="yourlinkId" target="_blank" href="<?php echo base_url();?>EC_Auction_itemize/print_e_auction_log/<?php echo $Detail_Auction['NO_TENDER']?>/<?php echo $nobatch ?>" type="button" style="margin-right: 20px" class="printt btn btn-default pull-right" aria-label="Left Align" >
									<span class="glyphicon glyphicon-print" aria-hidden="true"></span>
								</a>
							</div>
							<div class="panel-body">
