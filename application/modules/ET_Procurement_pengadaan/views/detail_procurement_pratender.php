<section class="content_section">
                            ...
                            <tr class="ro_hide">
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <input id="batasatasnego" type="text" name="ptp_batas_nego"class="form-control" value="<?php echo $ptp['PTP_BATAS_NEGO']==''?0:$ptp['PTP_BATAS_NEGO'] ?>" onkeypress="return isNumberKey(event)">
                                                <span class="input-group-addon">%</span>
                                            </div>
                                        </div>
    ...
    <input type="hidden" value="<?php echo $ptp['PTP_TERM_DELIVERY']; ?>" id="sny_id_term" name="sny_id_term" /><span  style="color:red; padding-left:20px; font-weight:bold;  display:none" id="msg_term" name="msg_term">** Masukkan Term of Delivery Description </span>
                    ...
                    <div class="panel panel-default panelvendor_barang pnl_satu" style="display: none;">
                        <div class="panel-heading">
                            Pilih Vendor
                        </div>
                        <div class="panel-body">
                    ...
                    <div class="panel panel-default panel_jasa_tambahan" style="display: none;">
                    ...
                    <div class="panel panel-default panelvendor_barang pnl_dua" style="display: none;">                    
