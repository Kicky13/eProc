  ...
  function __construct()
    ...
    function goodIssue($inputData){
      ...
      if(isset($inputData['GOODSMVT_HEADER'])){
          $inputData['GOODSMVT_HEADER']['VER_GR_GI_SLIP']  = '3';
          $inputData['GOODSMVT_HEADER']['VER_GR_GI_SLIPX']  = 'X';
          $inputData['GOODSMVT_HEADER']['VER_GR_GI_SLIPS']  = 'X';
          $inputData['GOODSMVT_HEADER']['REF_DOC_NO']  = $inputData['GOODSMVT_HEADER']['PR_UNAME'];
          unset($inputData['GOODSMVT_HEADER']['PR_UNAME']);
