...
<!--                                         <?php
                                        ...
                                        $muncul = "";
                                        if(strtotime($now)>=strtotime($first_day_this_month) && strtotime($now)<=strtotime($five_day_this_month)){
                                            $muncul = "ok";
                                        } elseif (strtotime($now)>=strtotime($twentyfive_day_this_month) && strtotime($now)<=strtotime($last_day_this_month)) {
                                            $muncul = "ok";
                                        }
                                        ?>
                                        <?php 
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="text-center ts0"><a href="javascript:void(0)">No.</th>
                                                        ...
                                                        <th class="text-center ts3"><a href="javascript:void(0)">No. Faktur Pajak</a></th>
                                                        <th class="text-center ts4"><a href="javascript:void(0)">Tanggal FP</a></th>
                                                        <th class="text-center ts5"><a href="javascript:void(0)">Tanggal BAST/BAPP</a></th>
                                                        <th class="text-center ts6"><a href="javascript:void(0)">Nilai DPP</a></th>
                                                        ...
                                                        <th class="text-center ts11"><a href="javascript:void(0)"></a></th>
                                                    </tr>
                                                    <tr class="sear">
                                                        <th></th>
