                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <table id="table_inv" class="table table-striped nowrap" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center ts1"><a href="javascript:void(0)">PO</a></th>
                                            <th class="text-center ts2"><a href="javascript:void(0)">Vendor</a></th>
                                            <th class="text-center ts3"><a href="javascript:void(0)">Value</a></th>
                                            <th class="text-center ts5"><a href="javascript:void(0)">Curr</a></th>
                                            <th class="text-center ts6"><a href="javascript:void(0)">Doc Date</a></th>
                                            <th class="text-center ts7"><a href="javascript:void(0)">Commit Date</a></th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center ts1"><a href="javascript:void(0)">PO</a></td>
                                            <td class="text-center ts2"><a href="javascript:void(0)">Vendor</a></td>
                                            <td class="text-center ts3"><a href="javascript:void(0)">Value</a></td>
                                            <td class="text-center ts4"><a href="javascript:void(0)">Curr</a></td>
                                            <td class="text-center ts6"><a href="javascript:void(0)">Doc Date</a></td>
                                            <td class="text-center ts7"><a href="javascript:void(0)">Commit Date</a></td>
