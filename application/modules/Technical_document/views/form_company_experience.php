		<section class="content_section">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open('Administrative_document/do_insert_akta_pendirian',array('class' => 'form-horizontal current_edited_experience')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <?php echo form_dropdown('currency', $currency, '', 'class="form-control" id="currency_edit"'); ?>
                                    </div>
                                    <div class="col-sm-3">
            ...
            <div class="content_spacer">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo form_open('Technical_document/do_insert_experiences',array('class' => 'form-horizontal insert_experiences', 'autocomplete'=>'off')); ?>
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'hidden') ?>">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="category" class="col-sm-3 control-label">Nilai Proyek (Termasuk PPN)</label>
                                        <div class="col-sm-3">
                                            <?php echo form_dropdown('currency', $currency, '', 'class="form-control"'); ?>
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3 end">
                                            <div class="input-group date">
                                                <input type="text" name="start_date" class="form-control text-uppercase" readonly=""><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                            </div>
                                        </div>
                                        <label for="end_date" class="col-sm-3 control-label">Tanggal Selesai</label>
                                        <div class="col-sm-3 end">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover margin-bottom-20 <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : '' ?>" id="experiences">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody id="tableItem">
                                        ...
                                        <tr id="<?php echo $experience['CV_ID']; ?>">
                                            ...
                                            <td class="f_client_name hidden"><?php echo $experience['CLIENT_NAME']; ?></td>
                                            <td><?php if (isset($experience['CLIENT_NAME_DOC'])) { ?><a href="<?php echo base_url('Technical_document') ?>/viewDok/<?php echo $experience['CLIENT_NAME_DOC']; ?>" target="_blank"><?php echo $experience['CLIENT_NAME']; ?></a><?php } else {  echo $experience['CLIENT_NAME'];  } ?></td>
                                            <td class="f_project_name"><?php echo $experience['PROJECT_NAME']; ?></td>
                                            <td class="f_description"><?php echo $experience['DESCRIPTION']; ?></td>
                                            <td class="text-center f_currency"><?php echo $experience['CURRENCY']; ?></td>
                                            <td class="must_autonumeric f_amount"><?php echo $experience['AMOUNT']; ?></td>
                                            <td class="f_contract_no"><?php echo $experience['CONTRACT_NO']; ?></td>
                                            <td class="f_start_date"><?php echo vendorfromdate($experience['START_DATE']); ?></td>
                                            <td class="f_end_date"><?php echo vendorfromdate($experience['END_DATE']); ?></td>
                                            <td class="f_contact_person"><?php echo $experience['CONTACT_PERSON']; ?></td>
                                            <td class="f_contact_no"><?php echo $experience['CONTACT_NO']; ?></td>
                            ...
                            ?>
                                <div class="panel panel-default">
                                    <div class="panel-body text-right">
                                        ...
                                        <a href="<?php echo base_url('Technical_document/facility_and_equipment') ?>" class="main_button color7 small_btn">Back</a>
                                        <button id="saveandcont_experiences" class="main_button color1 small_btn" type="button">Save & Continue</button>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
