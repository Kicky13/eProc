		<section class="content_section">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open('Administrative_document/do_insert_akta_pendirian',array('class' => 'form-horizontal current_edited_principal')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="post_code_edit_p" name="post_code" maxlength="5">
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="updateSubkontraktorModal" tabindex="-1" role="dialog" aria-labelledby="updateSubkontraktor">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open('Administrative_document/do_insert_akta_pendirian',array('class' => 'form-horizontal current_edited_subkontraktor')); ?>
                                <input type="text" class="hidden" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
            ...
            <div class="modal fade" id="updateAffiliasiModal" tabindex="-1" role="dialog" aria-labelledby="updateAffiliasi">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open('Administrative_document/do_insert_akta_pendirian',array('class' => 'form-horizontal current_edited_affiliasi')); ?>
                                <input type="text" class="hidden" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
            ...
            <div class="content_spacer">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo form_open('Additional_document/do_insert_principal',array('class' => 'form-horizontal insert_principal', 'autocomplete'=>'off')); ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover margin-bottom-20 <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : '' ?>" id="principals">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody id="tableItem">
                                        ...
                                        <tr id="<?php echo $principal['ADD_ID']; ?>">
                                            ...
                                            <td><button type="button" class="main_button small_btn update_add_principal"><i class="ico-edit no_margin_right"></i></button> <a class="main_button small_btn" href="<?php echo 'Additional_document/do_remove_vendor_add/'.$principal['ADD_ID']; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="ico-remove no_margin_right"></i></a></td>
                                        </tr>
                                            <?php }
                                        ?>
                            ...
                            <?php echo form_open('Additional_document/do_insert_subcontractor',array('class' => 'form-horizontal insert_subcontractor', 'autocomplete'=>'off')); ?>
                            ...
                            <?php echo form_close(); ?>
                            <div class="table-responsive">
                                <table class="table table-hover margin-bottom-20 <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : '' ?>" id="subcontractors">
                                    <thead>
                                        <tr>
                                            <th class="text-center">No</th>
                                            <th>Nama</th>
                                    ...
                                    <tbody id="tableItem">
                                        ...
                                        <tr id="<?php echo $subcontractor['ADD_ID']; ?>">
                                            ...
                                            <td><button type="button" class="main_button small_btn update_add_subcontractor"><i class="ico-edit no_margin_right"></i></button> <a class="main_button small_btn" href="<?php echo 'Additional_document/do_remove_vendor_add/'.$subcontractor['ADD_ID']; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="ico-remove no_margin_right"></i></a></td>
                                        </tr>
                                            <?php }
                                        ?>
                            ...
                            <?php echo form_open('Additional_document/do_insert_affiliation_company',array('class' => 'form-horizontal insert_affiliation_company', 'autocomplete'=>'off')); ?>
                            ...
                            <?php echo form_close(); ?>
                            <div class="table-responsive">
                                <table class="table table-hover margin-bottom-20 <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : '' ?>" id="affiliation_companies">
                                    <thead>
                                        <tr>
                                            <th class="text-center">No</th>
                                            <th>Nama</th>
                                    ...
                                    <tbody id="tableItem">
                                        ...
                                        <tr id="<?php echo $affiliation_company['ADD_ID']; ?>">
                                            ...
                                            <td><button type="button" class="main_button small_btn update_add_affiliation"><i class="ico-edit no_margin_right"></i></button> <a class="main_button small_btn" href="<?php echo 'Additional_document/do_remove_vendor_add/'.$affiliation_company['ADD_ID']; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="ico-remove no_margin_right"></i></a></td>
                                        </tr>
                                            <?php }
                                        ?>
                            ...
                            ?>
                                <div class="panel panel-default">
                                    <div class="panel-body text-right">
                                        ...
                                        <a href="<?php echo base_url('Technical_document/Company_experience') ?>" class="main_button color7 small_btn">Back</a>
