        <section class="content_section">
            <div class="content_spacer">
                <div class="content">
                    <div class="main_title centered upper">
                        <h2><span class="line"><i class="ico-users"></i></span>Ringkasan Input</h2>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                <div class="panel-heading">
                                    Info Perusahaan
                                    <a href="#!" class="btn btn-sm btn-default invisible">a</a>
                                    <span class="pull-right"><strong><a class="btn btn-default btn-sm <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : ''?>" href="<?php echo site_url('Administrative_document/general_data'); ?>">Edit Data</a></strong></span>
                                </div>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Administrative_document/do_insert_general_address',array('class' => 'form-horizontal insert_address')); ?>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Administrative_document/do_insert_akta_pendirian',array('class' => 'form-horizontal insert_akta')); ?>
                            <?php $container = 'Akta Pendirian'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                <div class="panel-heading">
                                    Akta Pendirian
                                    <a href="#!" class="btn btn-sm btn-default invisible">a</a>
                                    <span class="pull-right"><strong><a class="btn btn-default btn-sm <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : ''?>" href="<?php echo site_url('Administrative_document/legal_data'); ?>">Edit Data</a></strong></span>
                                </div>
                                <input type="text" class="hidden" disabled="disabled" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                <div class="panel-body">
                                    <div class="table-responsive">
                                    <table class="table table-hover margin-bottom-20" id="vendor_akta">
                                        ...
                                        <tbody id="tableItem">
                                            ...
                                            <tr id="<?php echo $akta['AKTA_ID']; ?>">
                                                <td><?php echo $no++; ?></td>
                                                <td><?php if (!empty($akta['AKTA_NO_DOC'])){ ?><a target="_blank" href="<?php echo base_url('Additional_document') ?>/viewDok/<?php echo $akta['AKTA_NO_DOC']; ?>"><?php echo $akta['AKTA_NO']; ?></a> <?php } else {  echo $akta['AKTA_NO']; } ?></td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a target="_blank" href="<?php echo base_url('Additional_document') ?>/viewDok/<?php echo $akta['PENGESAHAN_HAKIM_DOC']; ?>">
                                                    <?php echo vendorfromdate($akta['PENGESAHAN_HAKIM']); ?></a>
                                                    <?php } else {  echo vendorfromdate($akta['PENGESAHAN_HAKIM']); } ?></td>
                                                <td class="text-center"><?php if (!empty($akta['BERITA_ACARA_NGR_DOC'])){ ?><a target="_blank" href="<?php echo base_url('Additional_document') ?>/viewDok/<?php echo $akta['BERITA_ACARA_NGR_DOC']; ?>"><?php echo vendorfromdate($akta['BERITA_ACARA_NGR']); ?></a><?php } else {  echo vendorfromdate($akta['BERITA_ACARA_NGR']); } ?></td>
                                            </tr>
                                                <?php } } ?>
                                        </tbody>
                                    </table>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Administrative_document/do_update_legal_data',array('class' => 'form-horizontal legal_form')); ?>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            if (!empty($vendor_detail["DOMISILI_NO_DOC"])) { ?>
                                                <label class="control-label"><span class="messageUpload"><a style="color: #666; text-decoration: underline" target="_blank" href="<?php echo base_url('Additional_document')."/viewDok/".$vendor_detail["DOMISILI_NO_DOC"]; ?>" title="File Attachment">File Attachment</a></span></label>
                                            <?php
                                            } ?>
                                        </div>
                                    </div>
                                    ...
                                    <?php if($vendor_detail["ADDRESS_COUNTRY"] == "ID"): ?>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="address_city" disabled="disabled" name="address_city" value="<?php echo @$city_list[$vendor_detail["ADDRESS_CITY"]] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="addres_prop" class="col-sm-3 control-label">Propinsi</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="addres_prop" disabled="disabled" name="addres_prop" value="<?php echo $province_list[$vendor_detail["ADDRES_PROP"]] ?>">
                                            </div>
                                        </div>
                                    <?php else: ?>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                        <?php if ($vendor_detail["ADDRESS_COUNTRY"] != '') { ?>
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            if (!empty($vendor_detail["NPWP_NO_DOC"])) { ?>
                                                <label class="control-label"><span class="messageUpload"><a style="color: #666; text-decoration: underline" target="_blank" href="<?php echo base_url('Additional_document')."/viewDok/".$vendor_detail["NPWP_NO_DOC"]; ?>" title="File Attachment">File Attachment</a></span></label>
                                            <?php
                                            } ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="npwp_city" disabled="disabled" name="npwp_city" value="<?php if($vendor_detail["NPWP_CITY"] == '' || $vendor_detail["NPWP_CITY"] == 0){echo $vendor_detail["NPWP_CITY"];} else { echo $city_list[$vendor_detail["NPWP_CITY"]];} ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="npwp_prop" class="col-sm-3 control-label">Propinsi</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="npwp_prop" disabled="disabled" name="npwp_prop" value="<?php if($vendor_detail["NPWP_PROP"] == '' || $vendor_detail["NPWP_PROP"] == 0){ echo $vendor_detail["NPWP_PROP"]; }else{ echo $province_list[$vendor_detail["NPWP_PROP"]]; }?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" disabled="disabled" class="form-control" value="<?php echo $vendor_detail["NPWP_PKP"]; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            if (!empty($vendor_detail["PKP_NO_DOC"])) { ?>
                                                <label class="control-label"><span class="messageUpload"><a style="color: #666; text-decoration: underline" target="_blank" href="<?php echo base_url('Additional_document')."/viewDok/".$vendor_detail["PKP_NO_DOC"]; ?>" title="File Attachment">File Attachment</a></span></label>
                                            <?php
                                            } ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            if (!empty($vendor_detail["SIUP_NO_DOC"])) { ?>
                                                <label class="control-label"><span class="messageUpload"><a style="color: #666; text-decoration: underline" target="_blank" href="<?php echo base_url('Additional_document')."/viewDok/".$vendor_detail["SIUP_NO_DOC"]; ?>" title="File Attachment">File Attachment</a></span></label>
                                            <?php
                                            } ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            if (!empty($vendor_detail["TDP_NO_DOC"])) { ?>
                                                <label class="control-label"><span class="messageUpload"><a style="color: #666; text-decoration: underline" target="_blank" href="<?php echo base_url('Additional_document')."/viewDok/".$vendor_detail["TDP_NO_DOC"]; ?>" title="File Attachment">File Attachment</a></span></label>
                                            <?php
                                            } ?>
                                        </div>
                                    </div>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Administrative_document/do_update_legal_data',array('class' => 'form-horizontal legal_form api')); ?>
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <?php
                                            if (!empty($vendor_detail["API_NO_DOC"])) { ?>
                                                <label class="control-label"><span class="messageUpload"><a style="color: #666; text-decoration: underline" target="_blank" href="<?php echo base_url('Additional_document')."/viewDok/".$vendor_detail["API_NO_DOC"]; ?>" title="File Attachment">File Attachment</a></span></label>
                                            <?php
                                            } ?>
                                        </div>
                                    </div>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Administrative_document/do_insert_akta_pendirian',array('class' => 'form-horizontal insert_commissioner')); ?>
                            <?php $container = 'Dewan Komisaris'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                <div class="panel-heading">
                                    Dewan Komisaris
                                    <a href="#!" class="btn btn-sm btn-default invisible">a</a>
                                    <span class="pull-right"><strong><a class="btn btn-default btn-sm <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : ''?>" href="<?php echo site_url('Administrative_document/company_board'); ?>">Edit Data</a></strong></span>
                                </div>
                                <input type="text" class="hidden" disabled="disabled" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                    ...
                                    <table class="table table-hover margin-bottom-20" id="vendor_board_commissioner">
                                        ...
                                        <tbody id="tableItem">
                                            ...
                                            <tr id="<?php echo $board['BOARD_ID']; ?>">
                                                ...
                                                <td><?php if (!empty($board['NPWP_FILE'])){ ?> <a href="<?php echo base_url('Vendor_update_profile'); ?>/viewDok/<?php echo $board['NPWP_FILE']; ?>" class="previousfile" target="_blank" ><?php echo $board['NPWP_NO']; ?></a> <?php } else {  echo $board['NPWP_NO']; } ?></td>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Administrative_document/do_insert_akta_pendirian',array('class' => 'form-horizontal insert_director')); ?>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Administrative_document',array('class' => 'form-horizontal insert_bank_data')); ?>
                            <?php $container = 'Rekening Bank'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                <div class="panel-heading">
                                    Rekening Bank
                                    <a href="#!" class="btn btn-sm btn-default invisible">a</a>
                                    <span class="pull-right"><strong><a class="btn btn-default btn-sm <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : ''?>" href="<?php echo site_url('Administrative_document/bank_and_financial_data'); ?>">Edit Data</a></strong></span>
                                </div>
                                <input type="text" class="hidden" disabled="disabled" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                <div class="panel-body">
                                    <div class="table-responsive">
                                    <table class="table table-hover margin-bottom-20" id="vendor_bank">
                                        ...
                                        <tbody id="bankItem">
                                            ...
                                            <tr id="<?php echo $bank['BANK_ID']; ?>">
                                                ...
                                                <td><?php echo $bank['BANK_POSTAL_CODE']; ?></td>
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <?php if($vendor_detail["FIN_AKTA_MDL_DSR_CURR"] != ''){ ?>
                                                <?php echo form_dropdown('fin_akta_mdl_dsr_curr', $currency, $vendor_detail["FIN_AKTA_MDL_DSR_CURR"], 'disabled="disabled" class="form-control"'); ?>
                                            <?php } else { ?>
                                                    <input type="text" class="form-control text-right" disabled="disabled">
                                            <?php }?>
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control text-right" id="fin_akta_mdl_dsr" disabled="disabled" name="fin_akta_mdl_dsr" value="<?php echo ($vendor_detail["FIN_AKTA_MDL_DSR"] ? set_value('fin_akta_mdl_dsr', number_format($vendor_detail["FIN_AKTA_MDL_DSR"])) : ''); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="fin_akta_mdl_str_curr" class="col-sm-3 control-label">Modal Disetor</label>
                                        <div class="col-sm-3">
                                            <?php if($vendor_detail["FIN_AKTA_MDL_STR_CURR"] != ''){ ?>
                                            <?php echo form_dropdown('fin_akta_mdl_str_curr', $currency, $vendor_detail["FIN_AKTA_MDL_STR_CURR"], 'disabled="disabled" class="form-control"'); ?>
                                            <?php } else { ?>
                                                    <input type="text" class="form-control text-right" disabled="disabled">
                                            <?php }?>
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control text-right" id="fin_akta_mdl_str" disabled="disabled" name="fin_akta_mdl_str" value="<?php echo ($vendor_detail["FIN_AKTA_MDL_STR"] ? set_value('fin_akta_mdl_str', number_format($vendor_detail["FIN_AKTA_MDL_STR"])) : ''); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <?php echo form_close(); ?>
                            <?php echo form_open('Administrative_document',array('class' => 'form-horizontal insert_financial_report')); ?>
                                    ...
                                    <table class="table table-hover margin-bottom-20" id="vendor_fin_report">
                                        ...
                                        <tbody id="finReportItem">
                                            ...
                                            <tr id="<?php echo $report['FIN_RPT_ID']; ?>">
                                                <td><?php echo $no++; ?></td>
                                                <td><?php if (!empty($report['FILE_UPLOAD'])){ ?> <a href="<?php echo base_url('Vendor_update_profile'); ?>/viewDok/<?php echo $report['FILE_UPLOAD']; ?>" class="previousfile" target="_blank" ><?php echo $report['FIN_RPT_YEAR']; ?></a> <?php } else {  echo $report['FIN_RPT_YEAR']; } ?></td>
                                                <!-- <td><?php echo $report['FIN_RPT_YEAR']; ?></td> -->
                                                <td><?php echo $report['FIN_RPT_TYPE']; ?></td>
                                                <td><?php echo $report['FIN_RPT_CURRENCY']; ?></td>
                                                <td><?php echo number_format($report['FIN_RPT_ASSET_VALUE']); ?></td>
                                                <td><?php echo number_format($report['FIN_RPT_HUTANG']); ?></td>
                                                <td><?php echo number_format($report['FIN_RPT_REVENUE']); ?></td>
                                                <td><?php echo number_format($report['FIN_RPT_NETINCOME']); ?></td>
                                            </tr>
                                                <?php }
                                            ?>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Technical_document/do_insert_good',array('class' => 'form-horizontal insert_good')); ?>
                            <?php $container = 'Barang dan bahan yang bisa dipasok'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                <div class="panel-heading">
                                    Barang dan Bahan yang Bisa Dipasok
                                    <a href="#!" class="btn btn-sm btn-default invisible">a</a>
                                    <span class="pull-right"><strong><a class="btn btn-default btn-sm <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : ''?>" href="<?php echo site_url('Technical_document/good_and_service_data'); ?>">Edit Data</a></strong></span>
                                </div>
                                <input type="text" class="hidden" disabled="disabled" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                <div class="panel-body">
                                    <div class="table-responsive">
                                    <table class="table table-hover margin-bottom-20" id="goods">
                                        ...
                                        <tbody id="tableItem">
                                            ...
                                            <tr id="<?php echo $good['PRODUCT_ID']; ?>">
                                                ...
                                                <td><?php if (!empty($good['FILE_UPLOAD'])){ ?><a href="<?php echo base_url('Additional_document'); ?>/viewDok/<?php echo $good['FILE_UPLOAD']; ?>" class="previousfile" target="_blank" ><?php echo $good['NO']; ?></a><?php } else {  echo $good["NO"]; } ?></td>
                                    ...
                                    <table class="table table-hover margin-bottom-20">
                                        ...
                                        <tbody id="tableItem">
                                            ...
                                            <tr id="<?php echo $good['PRODUCT_ID']; ?>">
                                                ...
                                                <td><?php echo $good['SOURCE']; ?></td>
                                                <td><?php echo $good['TYPE']; ?></td>
                                                <td><?php echo $good['KLASIFIKASI_NAME']; ?></td>
                                                <td><?php if (!empty($good['FILE_UPLOAD'])){ ?>
                                                        <a href="<?php echo base_url('Technical_document'); ?>/viewDok/<?php echo $good['FILE_UPLOAD']; ?>" class="previousfile" target="_blank" ><?php echo $good['NO']; ?></a>
                                                    <?php } else {  echo $good["NO"]; } ?> 
                                                </td>
                                                <td><?php echo $good['ISSUED_BY']; ?></td>
                                                <td class="issued_date_bahan"><?php echo vendorfromdate($good['ISSUED_DATE']); ?></td>
                                                <td class="expired_date_bahan"><?php echo vendorfromdate($good['EXPIRED_DATE']); ?></td>
                                                <td><button type="button" class="main_button small_btn update_bahan"><i class="ico-edit no_margin_right"></i></button> <a class="main_button small_btn" href="<?php echo 'do_remove_vendor_product/'.$good['PRODUCT_ID']; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="ico-remove no_margin_right"></i></a></td>
                                            </tr>
                                                <?php }
                                            ?>
                                    ...
                                    <table class="table table-hover margin-bottom-20" id="services">
                                        ...
                                        <tbody id="tableItem">
                                            ...
                                            <tr id="<?php echo $service['PRODUCT_ID']; ?>">
                                                ...
                                                <td class="text-center"><?php if (!empty($service['FILE_UPLOAD'])){ ?> <a href="<?php echo base_url('Additional_document'); ?>/viewDok/<?php echo $service['FILE_UPLOAD']; ?>" class="previousfile" target="_blank" ><?php echo $service['NO']; ?></a> <?php } else {  echo $service['NO']; } ?> </td>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Technical_document/do_insert_sdm',array('class' => 'form-horizontal insert_main_sdm')); ?>
                            <?php $container = 'Tenaga Ahli Utama'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                <div class="panel-heading">
                                    Tenaga Ahli Utama
                                    <a href="#!" class="btn btn-sm btn-default invisible">a</a>
                                    <span class="pull-right"><strong><a class="btn btn-default btn-sm <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : ''?>" href="<?php echo site_url('Technical_document/human_resources_data'); ?>">Edit Data</a></strong></span>
                                </div>
                                <input type="text" class="hidden" disabled="disabled" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                <div class="panel-body">
                                    <div class="table-responsive">
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Technical_document/do_insert_sdm',array('class' => 'form-horizontal insert_support_sdm')); ?>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Technical_document/do_insert_certifications',array('class' => 'form-horizontal insert_certifications')); ?>
                            <?php $container = 'Keterangan Sertifikat'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                <div class="panel-heading">
                                    Keterangan Sertifikat
                                    <a href="#!" class="btn btn-sm btn-default invisible">a</a>
                                    <span class="pull-right"><strong><a class="btn btn-default btn-sm <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : ''?>" href="<?php echo site_url('Technical_document/certification_data'); ?>">Edit Data</a></strong></span>
                                </div>
                                <input type="text" class="hidden" disabled="disabled" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <tbody id="tableItem">
                                            ...
                                            <tr id="<?php echo $certifications['CERT_ID']; ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <a target="_blank" href="<?php echo base_url('Additional_document') ?>/viewDok/<?php echo $certifications['CERT_NO_DOC']; ?>"><?php echo $certifications['CERT_NO']; ?></a>
                                                    <?php } else {?>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Technical_document/do_insert_equipments',array('class' => 'form-horizontal insert_equipments')); ?>
                            <?php $container = 'Keterangan Tentang Fasilitas dan Peralatan'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                <div class="panel-heading">
                                    Keterangan Tentang Fasilitas dan Peralatan
                                    <a href="#!" class="btn btn-sm btn-default invisible">a</a>
                                    <span class="pull-right"><strong><a class="btn btn-default btn-sm <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : ''?>" href="<?php echo site_url('Technical_document/facility_and_equipment'); ?>">Edit Data</a></strong></span>
                                </div>
                                <input type="text" class="hidden" disabled="disabled" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                <div class="panel-body">
                                    <div class="table-responsive">
                                    <table class="table table-hover margin-bottom-20" id="equipments">
                                        ...
                                        <tbody id="tableItem">
                                            <?php if (empty($equipments[0]['CERT_NAME'])) { ?>
                                            <tr id="empty_row">
                                                <td colspan="7" class="text-center">- Belum ada data -</td>
                                            </tr>
                                            <?php
                                            ...
                                            <tr id="<?php echo $equipment['EQUIP_ID']; ?>">
                                                ...
                                                <td><?php echo $equipment['SPEC']; ?></td>
                                                <td><?php echo $equipment['QUANTITY']; ?></td>
                                                <td><?php echo $equipment['YEAR_MADE']; ?></td>
                                            </tr>
                                                <?php }
                                            ?>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Technical_document/do_insert_experiences',array('class' => 'form-horizontal insert_experiences')); ?>
                            <?php $container = 'Pekerjaan'; ?>
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                <div class="panel-heading">
                                    Pengalaman Perusahaan
                                    <a href="#!" class="btn btn-sm btn-default invisible">a</a>
                                    <span class="pull-right"><strong><a class="btn btn-default btn-sm <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : ''?>" href="<?php echo site_url('Technical_document/company_experience'); ?>">Edit Data</a></strong></span>
                                </div>
                                <input type="text" class="hidden" disabled="disabled" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <tbody id="tableItem">
                                            ...
                                            <tr id="<?php echo $experience['CV_ID']; ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <a target="_blank" href="<?php echo base_url('Additional_document') ?>/viewDok/<?php echo $experience['CLIENT_NAME_DOC']; ?>"><?php echo $experience['CLIENT_NAME']; ?></a>
                                                    <?php } else {?>
                            ...
                            <div class="panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>">
                                <div class="panel-heading">
                                    Principal
                                    <a href="#!" class="btn btn-sm btn-default invisible">a</a>
                                    <span class="pull-right"><strong><a class="btn btn-default btn-sm <?php echo isset($progress_status[$container]) ? ($progress_status[$container]['STATUS'] == 'Approved' ? 'hidden' : '') : ''?>" href="<?php echo site_url('Additional_document'); ?>">Edit Data</a></strong></span>
                                </div>
                                <input type="text" class="hidden" disabled="disabled" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                <div class="panel-body">
                                    <div class="table-responsive">
                            ...
                            <?php echo form_open('Additional_document/do_insert_subcontractor',array('class' => 'form-horizontal insert_subcontractor')); ?>
                            ...
                            <?php echo form_close(); ?>
                            <?php echo form_open('Additional_document/do_insert_affiliation_company',array('class' => 'form-horizontal insert_affiliation_company')); ?>
                        ...
                        <div class="panel-group">
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover">
                                        <tr>
                                            ...
                                            <td><textarea maxlength="1000" class="form-control" name="comment" id="comment" /></textarea></td>
                            ...
                            <!-- <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <textarea class="form-control" style="resize: vertical" rows="4">Kami menyatakan bahwa data yang kami input adalah benar data perusahaan kami, dan apabila di kemudian hari kami mengingkari pernyataan di atas atau ditemui bahwa keterangan/data perusahaan yang kami berikan tidak benar, maka kami bersedia dituntut di muka pengadilan dan bersedia dikeluarkan dari daftar vendor serta dimasukkan dalam daftar hitam (black list) eProcurement PT Semen Indonesia (Persero) Tbk.</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div> -->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body text-center">
                                    ...
                                    <a href="#finish-popup" class="main_button color1 small_btn popup-with-move-anim" type="button">Send & Finish</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="zoom-anim-dialog large-dialog mfp-hide" id="finish-popup">
                ...
                <div class="modal-body" style="max-height: 300px; overflow-y: auto;">
                    ...
                    <p class="text-justify">Anda yakin hendak menyelesaikan proses update profile ini? Anda bisa kembali ke halaman sebelumnya untuk melakukan review!</p>
                    <?php else: ?>
                        <p class="text-justify">Anda yakin hendak menyelesaikan proses pendaftaran ini? Anda bisa kembali ke halaman sebelumnya untuk melakukan review!</p>
                    <?php endif ?>
                </div>
