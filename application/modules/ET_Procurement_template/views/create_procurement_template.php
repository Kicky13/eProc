...
<section class="content_section">
    <div class="content_spacer">
        <div class="content">
            ...
            <?php echo form_open_multipart('ET_Procurement_template/',array('class' => 'form-horizontal form_valid')); ?>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <table class="table" id="tbl_parent_item">
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" class="form-control" name="ppd_weight" id="ppd_weight">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="col-md-3">Fix</td>
                                                <td>
                                                    <input type="checkbox" id="ppd_mode" name="ppd_mode" value="1" checked disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="col-md-3">User Otorisasi</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="col-md-3">Prasyarat</td>
                                                <td>
                                                    <label class="radio-inline"><input type="radio" name="optradioprasyarat" value="1">Ya</label>
                                                    <label class="radio-inline"><input type="radio" name="optradioprasyarat" value="0" checked>Tidak</label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr id="sub_item_bobot" style="display: none;">
                                                <td class="col-md-3">Bobot</td>
                                                <td><input type="text" class="form-control" name="pptu_weight" id="pptu_weight"></td>
                                            </tr>
                                            <tr id="sub_item_type" style="display: none;">
                                                <td class="col-md-3">Type</td>
                                                <td>
                                                    <label class="radio-inline"><input type="radio" name="optradiotype" value="1">Multiple Choice</label>
                                                    <label class="radio-inline"><input type="radio" name="optradiotype" value="2">Input Text</label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <table class="table table-hover table-bordered">
                                        <thead>
                                            ...
                                            <th class="text-center col-md-3">User Otorisasi</th>
