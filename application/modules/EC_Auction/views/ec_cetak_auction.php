				...
				<tr>
					...
					<td style="padding-top:5px" >
						<table>
							...
							<tr>
								<td style="padding-left:20px;" valign="top">-</td>
								<td align="justify">Penurunan harga penawaran, disarankan tidak kurang dari 60 (enam puluh) detik sebelum closing, karena tidak dijamin oleh PT. Semen Indonesia (Persero) Tbk.</td>
							</tr>
							<tr>
								<td style="padding-left:20px;" valign="top">-</td>
								<td align="justify">Calon Pemenang adalah penawar terendah hasil print out berita acara e-auction</td>
							</tr>
							<tr>
								<td style="padding-left:20px;" valign="top">-</td>
