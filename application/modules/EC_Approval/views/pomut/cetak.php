...
<table border='1' class="small">
	...
	<tr>
		<th class="c"><?php echo $header['MIC1'] == NULL ? '-' : $header['MIC1'];?></th>
        <th class="c"><?php echo $header['MIC2'] == NULL ? '-' : $header['MIC2'];?></th>
        <th class="c"><?php echo $header['MIC3'] == NULL ? '-' : $header['MIC3'];?></th>
        <th class="c"><?php echo $header['MIC1'] == NULL ? '-' : $header['MIC1'];?></th>
        <th class="c"><?php echo $header['MIC2'] == NULL ? '-' : $header['MIC2'];?></th>
        <th class="c"><?php echo $header['MIC3'] == NULL ? '-' : $header['MIC3'];?></th>
	</tr>
...
<br><br>
<span class="small">Harga bahan = <?=ribuan($harga_satuan['HARSAT']);?> / Ton</span><br>
<?php
