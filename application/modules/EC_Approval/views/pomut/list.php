                            ...
                            <div class="panel-group skrol" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="row" style="border-bottom: 1px solid #ccc;">
                                            <br>
                                            <a data-hariini="<?php echo date('Ymd') ?>" data-href="<?php echo base_url('EC_Approval/Pomut_cronjob/setDataPomut') ?>" onclick="manualRefreshPomut(this); return false" class="btn btn-info pull-right" style="margin: 0 15px 10px 0;">Refresh BA</a>                                                                        
                                    </div>
