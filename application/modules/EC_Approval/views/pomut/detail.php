                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12 col-lg-12">
                          <div class="col-md-6 col-sm-6 col-lg-6 col-lg-6">  
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                  <input type="text" readonly value="<?php echo $po_no ?>" name="PO"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                  <input type="text" readonly value="<?php echo $material ?>" name="MATERIAL"/>    
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12 ">
                                  ...
                                  <table class="table table-bordered table-collapse text-center">
                                    <thead>
                                      ...
                                      <tr>
                                        <th class="text-center"><?php echo $header['MIC1'] == NULL ? '-' : $header['MIC1'];?></th>
                                        <th class="text-center"><?php echo $header['MIC2'] == NULL ? '-' : $header['MIC2'];?></th>
                                        <th class="text-center"><?php echo $header['MIC3'] == NULL ? '-' : $header['MIC3'];?></th>
                                        <th class="text-center"><?php echo $header['MIC1'] == NULL ? '-' : $header['MIC1'];?></th>
                                        <th class="text-center"><?php echo $header['MIC2'] == NULL ? '-' : $header['MIC2'];?></th>
                                        <th class="text-center"><?php echo $header['MIC3'] == NULL ? '-' : $header['MIC3'];?></th>
                                      </tr>
