                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="<?php echo base_url();?>EC_Auction_itemize_negotiation/indexBatch/<?php echo $Detail_Auction['NO_TENDER']; ?>" type="button" style="margin-top: 15px" class="btn btn-danger pull-left" aria-label="Left Align" >
                                Pilih Batch 
                            </a>
