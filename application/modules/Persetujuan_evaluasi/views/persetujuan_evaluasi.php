                                ...
                                <?php else: ?>
                                    <?php foreach ($dokumentambahan as $key => $value): ?>
                                        ...
                                        <div class="col-md-4 text-right">
                                            <input id="itemise_2" type="radio" name="share[<?php echo $value['ADD_ID'] ?>]" value="1" <?php echo $value['IS_SHARE'] == 1 ? 'checked' : '' ?> > <?php echo "Share"; ?>
                                        </div>
                                        <div class="col-md-4">
                                            <input id="itemise_3" type="radio" name="share[<?php echo $value['ADD_ID'] ?>]" value="0" <?php echo $value['IS_SHARE'] == 0 ? 'checked' : '' ?> > <?php echo "Not Share" ?>
                                        </div>
