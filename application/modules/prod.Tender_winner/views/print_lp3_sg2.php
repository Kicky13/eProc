...
<body>
	<div class="container">
        ...
        <span style="display:block;padding-bottom:1px;font-size:9pt;">
            I. Undangan Penawaran: <?php echo date('d M Y',strtotime($ptm['PTM_CREATED_DATE'])); ?> - <?php echo date('d M Y',$releaseComplete); ?>
        </span>
        ...
        <br/>
        <span style="display:block;padding-bottom:1px;font-size:9pt;">
            II. Rekap Penawaran Yang Respon: <?php echo ($verifikasiPenawaran!='')?date('d M Y',$verifikasiPenawaran):''; ?>
        </span>
        <table class="table">
            <thead>
                <tr>
