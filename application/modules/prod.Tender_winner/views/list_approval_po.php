                                        ...
                                        <?php $no = 1; foreach ($value['item'] as $val): ?>
                                            <?php if($no == 1): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center" rowspan="<?php echo $value['nitem'] ?>"><a href="<?php echo base_url("Tender_winner/detailPO/".$poid."/true") ?>" class="btn btn-default col-md-12 <?php echo $state?'':'hidden';?>"><i class="glyphicon glyphicon-search"></i></a></td>
