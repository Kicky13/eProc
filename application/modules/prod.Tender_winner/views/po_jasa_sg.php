...
if($po['LP3_NUMBER']=='LP320000299'){
	?>
	<img style="height: 60px;width: 65px;" class="logo_dark" src="https://eprocurement.semenindonesia.com/eproc/static/images/logo/logo_sm_gresik.png" alt="Logo eProcurement PT. Semen Gresik">
	<b>PT Semen Gresik</b>
	<?php
} else {
	?>
