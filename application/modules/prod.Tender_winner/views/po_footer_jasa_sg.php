<div id="footer">
    <table class="setting_bold spasisiji">
        <tr>
            <td>Tanggal Order</td>
            <td>:</td>
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                <?php if ($this->session->userdata('COMPANYID') == 2000 || $this->session->userdata('COMPANYID') == 5000) {?>
                01.001.631.9-051.000
                <?php } ?> &nbsp;&nbsp;<b>KETENTUAN UMUM (TERLAMPIR)</b>
            </td>
        </tr>                
    </table>            
    <hr>
    <table class="">
        <tr>
            ...
            <td style="font-size: 9px;" width="40%" class="text-left">
                Sesuai dengan ketentuan yang berlaku, PT. Semen Gresik mengatur bahwa Perintah Kerja ini telah ditandatangani secara elektronik sehingga tidak diperlukan tanda tangan basah pada Perintah Kerja ini.
            </td>
        </tr>
    </table>
    <table class="">
