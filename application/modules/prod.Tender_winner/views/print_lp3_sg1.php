...
<body>
    <div class="container">
        <div class="judul">
            <?php
        //yang di ganti logo semen gresik
            if($po_header['LP3_NUMBER']=='LP320000299'){
                ?>
                <img width="50" height="50" src="http://int-eprocurement.semenindonesia.com/eproc/static/images/logo/logo_sm_gresik.png" alt="Logo eProcurement PT. Semen Tonasa">

                <?php
            } else {
                ?>
                <img width="50" height="50" src="http://int-eprocurement.semenindonesia.com/eproc/static/images/logo/semenindonesia.png" alt="Logo eProcurement PT. Semen Tonasa">
        ...
        <table>
            <tr>
                <td width="150px">Nama Pengadaan</td>
                <td width="15px">:</td>
            ...
            <tr>
                <td>Jangka Waktu</td>
                <td>:</td>
                <td><?php echo date("d-m-Y", oraclestrtotime($po_header['DOC_DATE']))." s/d ".date("d-m-Y", oraclestrtotime($po_header['DDATE'])) ?></td>
            </tr>
        </table>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th class="title data" >Nama Barang/Pekerjaan</th>
                    <th class="title data" >Qty</th>
                    <th class="title data" >UoM</th>
                    <th class="title data" >Harga Satuan</th>
                    <th class="title data" >Harga Total</th>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td valign="top">:</td>
                    <td valign="top">
                        <!-- <?php echo nl2br(str_replace('  ', '&nbsp;&nbsp;&nbsp;', $po_header['HEADER_TEXT'])) ?> -->
                        <?php
                        if($po_header['PO_NUMBER']==6400003949 || $po_header['PO_NUMBER']==6400003952 || $po_header['PO_ID']>=170){
                            ?>
                            <?php echo html_entity_decode($po_header['HEADER_TEXT']) ?>
                            <?php
                        } else {
                            ?>
                            <!-- <pre><?php echo $po_header['HEADER_TEXT'] ?></pre> -->
                            <?php echo nl2br(str_replace('  ', '&nbsp;&nbsp;&nbsp;', $po_header['HEADER_TEXT'])) ?>
                            <?php
                        }
                        ?>
            ...
            <table class="table">
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td>Tuban, <?php echo date('d-m-Y'); ?></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
