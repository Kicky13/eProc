...
class EC_Cronjob extends MX_Controller {
    ...
    public function refreshGR($tglGr = NULL) {
...
//                echo $this->db->last_query().'<br >';
        ...
        if ($tglGrCari >= $cutOff) {
            ...
            $this->getGRNonApprove($tglGrCari);
    ...
    public function setDataLanded($tglGrCari) {
    ...
    public function getGRNonApprove($tglGrCari) {
        $sql = <<<SQL
