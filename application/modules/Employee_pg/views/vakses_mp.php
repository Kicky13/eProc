    ...
    <div class="content_spacer">
      <div class="content">
        <div class="main_title centered upper">
          <h2><span class="line"><i class="ico-users"></i></span>Mapping Purchasing Group</h2>
        </div>
        <div class="row">
          <!-- Tabs Container -->
          <div class="panel panel-default">
            <div class="panel-heading">Mapping Purchasing Group</div>

            <div class="panel-body">   
              <div class="col-md-12 ">
                <form id="form_ms_proccess" method="post" name="form_ms_proccess" action="<?php echo base_url('Employee_pg/simpan_detil_proccess')?>" class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">  
                      ...
                      <div class="field">
                        ...
                        <?=form_dropdown('company',$company_name,'','id="company"  class="form-control"')?>
                        <span class="help-block"></span>
                      </div>
...
<!-- 
                  <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">  
                        ...
                        <div class="field">
                          ...
                          <?=form_dropdown('nama_pg',$nama_pg,'','id="nama_pg"  class="form-control"')?>
                          <span class="help-block"></span>
                        </div>
                      </div> -->
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 " style="padding-top:2%">  
                      ...
                      <label>
                        ...
                        <input type="hidden" id="idem" name="idem" value="" />
                      ...
                      <br>
                        ...
                        <div class="field col-xs-12 col-sm-5 col-md-5">
                          <label>Purchasing Group</label>
                            <?=form_dropdown('nama_pg',$nama_pg,'','id="nama_pg"  class="form-control"')?>
                            <span class="help-block"></span>
                        </div>
     ...
     // updateDataTableSelectAllCtrl(table);
      ...
      e.stopPropagation();
			 ...
			 $("#get_unit").click(function(){
			  ...
			  $.ajax({
				  		type: "post",
						url:'<?php echo base_url() ?>index.php/Employee_pg/load_data_unit/'+$('#company').val(),
						dataType: "html",
						cache: true,
