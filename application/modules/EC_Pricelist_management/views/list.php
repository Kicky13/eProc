              ...
              <table id="tableMT" class="table table-striped nowrap" width="100%">
                <thead>
                  <tr>
                    ...
                    <th class="text-center ts3"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_shrt']; ?></a></th>
                    ...
                    <th class="text-center ts11"><a href="javascript:void(0)"><?php echo $baseLanguage['list_contract_nprc']; ?></th>
                  ...
                  <tr id="sear">
                    <th> </th>
                    <th><!-- All:<input type="checkbox" class="onoff"> --></th>
