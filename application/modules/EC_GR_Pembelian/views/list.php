                    ...
                    <div id="Invoiced">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="panel-group skrol" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <table id="table_gr" class="table table-striped nowrap" width="100%">
                                        <thead>
                                        <tr>
                                            ...
                                            <th class="text-center ts3"><a href="javascript:void(0)">Tanggal Beli</a></th>
                                            <th class="text-center ts4"><a href="javascript:void(0)">Vendor</a></th>
                                            <!-- <th class="text-center ts5"><a href="javascript:void(0)">Tanggal Approve</a></th> -->
											<th class="text-center ts6"><a href="javascript:void(0)">Quantity All</a></th>
                                            <th class="text-center ts7"><a href="javascript:void(0)">QTY Shipment</a></th>
                                            <th class="text-center ts8"><a href="javascript:void(0)">Status<!-- &nbsp;<span class="badge"><?php //echo $count ?></span> --></a></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <table id="tableTrack" class="table table-striped nowrap" width="100%">
                            ...
                            <tr>
                                ...
                                <th class="text-center">Check All<br><input type="checkbox" name="itemShipment"></th>   
                            </tr>
                            </thead>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <button type="button" class="btn btn-success" id="acceptShipment">Accept</button>&nbsp;&nbsp;&nbsp;
                        <button type="button" class="btn btn-danger" id="rejectShipment">Reject</button>
                    </div>
