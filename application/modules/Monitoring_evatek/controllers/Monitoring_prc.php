...
class Monitoring_evatek extends CI_Controller {
	...
	public function detail($id){
		...
		if($ptp['PTP_IS_ITEMIZE']==1){
			$data['evaluasi'] = $this->snippet->evaluasi($id, false,true,false,false,false,false,false,'vendor_per_item');
		}else{
			$data['evaluasi'] = $this->snippet->evaluasi($id, false,true,false,false,false,false,false,'item_per_vendor');
		}
	...
	public function get_datatable() {
		...
		// $request = $this->session->userdata('MKCCTR');
		$this->prc_tender_main->join_prep();
