<section class="content_section">
    <div class="content_spacer">
        <div class="content">
            ...
            <form name="quotation-form" id="quotation-form" method="post" action="<?php echo base_url() ?>Update_pengadaan/submit">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <table class="table table-hover">
                                <tr>
                                    <td class="col-md-4"><strong>User</strong></td>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body text-center">
                                <button type="submit" class="main_button color6 small_btn">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
