...
<section class="content_section">
    <div class="content_spacer">
        ...
        <?php echo form_open_multipart($urlAction, array('method' => 'POST', 'class' => 'form-horizontal','data-id' => $id,'data-urlcekdata' => site_url('EC_Vendor/Bapp/checkQty'),'data-urlkonfirmasi'=> site_url('EC_Vendor/Bapp/kofirmasiVendor'))); ?>
        <div class="form-group" style="visibility:<?php echo $dataBapp['STATUS'] != '4' ? "hidden" : ''; ?>">
            <label for="Invoice No" class="col-sm-3 control-label">Alasan Reject</label>
            <div class="col-sm-9">
                <textarea  readonly class="form-control" rows="2"><?php echo $dataBapp['ALASAN_REJECT'] ?></textarea>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-2 <?php echo $hiddenBtn ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <input type="hidden" class="form-control"  name="MTRL_GROUP" readonly value="<?php echo $dataBapp['MTRL_GROUP'] ?>">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="qty" class="col-sm-3 control-label">Detail Pekerjaan</label>
            <div class="col-sm-9">
                <select class="form-control" name="SERVICE" required onchange="setServiceDesc(this)">
                  <?php
                    if(!empty($dataBapp['SERVICE'])){
                      echo '<option value="'.$dataBapp['SERVICE'].'">'.$dataBapp['SERVICE_DESC'].'</option>';
                    }
                  ?>
                </select>
                <input type="hidden" name="SERVICE_DESC"  value="<?php echo $dataBapp['SERVICE_DESC'] ?>" />
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="QTY"  value="<?php echo $dataBapp['QTY'] ?>" >
            </div>
        </div>
      <!--
        <div class="form-group">
            <label for="no_bapp" class="col-sm-3 control-label">No. BAPP</label>
            <div class="col-sm-9">
                <input type="text" class="form-control"  readonly name="NO_BAPP"  value="<?php echo $dataBapp['NO_BAPP'] ?>" >
            </div>
        </div>
      -->
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <textarea class="form-control editor-html"  required name="DESCRIPTION" <?php echo $isReadonly ?> ><?php echo $dataBapp['DESCRIPTION'] ?></textarea>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input class="form-control" name="JABATAN" value="<?php echo $dataBapp['JABATAN'] ?>">
                    ...
                    <tbody id="tbody-doc">
                      ...
                      if(!empty($bappDoc)){
                        ...
                        foreach($bappDoc as $bd){
                          $inputFile = $bisaEdit ? '<input type="file" name="fileLampiranBapp_'.$_index.'">' : '';
                          echo '<tr>
                            <td>'.$_index.'</td>
                            <td class="text-center"><input type="text" readonly name="lampiranBapp['.$_index.']" value="'.$bd['DESCRIPTION'].'"> </td>
                            <td class="text-center">'.$inputFile.'<input type="hidden" name="oldFileLampiranBapp['.$_index.']" value="'.$bd['PIC'].'"><a target="_blank" href="'.site_url('upload/EC_invoice/'.$bd['PIC']).'">'.$bd['PIC'].'</a></td>
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-3">
                <button class="btn btn-info preview-btn" data-urlpreview="<?php echo site_url('EC_Vendor/Bapp/preview')?>" type="button">Preview</button>
