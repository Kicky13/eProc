                                  ...
                                  <div class="tab-content">
                                      <div role="tabpanel" class="tab-pane active" id="request">
                                          <div class="row" style="border-bottom: 1px solid #ccc;">
                                                  <br>
                                                  <a href="<?php echo base_url('EC_Vendor/Bast/form') ?>" class="btn btn-info pull-right" style="margin: 0 15px 10px 0;">Create BAST</a>
                                                  <br>
                                          </div>
                                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow : auto">
                                              <table class="table table-striped table_bast nowrap" width="100%">
                                                  <thead>
                                                          <tr>
                                                              <th class="text-center ts"><a href="javascript:void(0)">No.</th>
                                                              <th class="text-center ts"><a href="javascript:void(0)">No. PO</a></th>
                                                              <th class="text-center ts"><a href="javascript:void(0)">PO Item</a></th>
                                                              <th class="text-center ts"><a href="javascript:void(0)">No. BAST</a></th>
                                      ...
                                      <div role="tabpanel" class="tab-pane" id="approved">
                                          ...
                                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow : auto">
                                              <table  class="table table-striped nowrap table_bast" width="100%">
                                                  <thead>
                                                          <tr>
                                                              <th class="text-center ts"><a href="javascript:void(0)">No.</th>
                                                              <th class="text-center ts"><a href="javascript:void(0)">No. PO</a></th>
