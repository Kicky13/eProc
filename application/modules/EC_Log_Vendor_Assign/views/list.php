                            ...
                            <div class="panel-group skrol" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <table id="table_inv" class="table table-striped nowrap" width="100%">
                                        <thead>
                                        <tr>
                                            <th class="text-center ts0"><a href="javascript:void(0)">Log Date</th>
                                            ...
                                            <th class="text-center ts4"><a href="javascript:void(0)">User</a></th>
                                        ...
                                        <tbody>
                                        <tr>
                                            <td class="text-center ts0"><a href="javascript:void(0)">Log Date</td>
                                            ...
                                            <td class="text-center ts4"><a href="javascript:void(0)">User</a></td>
