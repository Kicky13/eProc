		<section class="content_section">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open('Vendor_update_profile/do_insert_akta_pendirian',array('class' => 'form-horizontal current_edited_utama')); ?>
                                <input type="text" class="hidden" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                <input type="hidden" id="container" name="container" value="Tenaga Ahli Utama">
            ...
            <div class="modal fade" id="updateTenagaPendukungModal" tabindex="-1" role="dialog" aria-labelledby="updateTenagaPendukung">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php echo form_open('Vendor_update_profile/do_insert_akta_pendirian',array('class' => 'form-horizontal current_edited_ahli')); ?>
                                <input type="text" class="hidden" name="vendor_id" value="<?php echo set_value('vendor_id', $vendor_detail["VENDOR_ID"]); ?>">
                                <input type="hidden" id="container" name="container" value="Tenaga Ahli Pendukung">
            ...
            <div class="content_spacer">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo form_open('Vendor_update_profile/do_insert_sdm',array('class' => 'form-horizontal insert_main_sdm', 'autocomplete'=>'off')); ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover margin-bottom-20 panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>" id="main_sdm">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody id="tableItem">
                                        ...
                                        <tr id="<?php echo $sdm['SDM_ID']; ?>">
                                            ...
                                            <td class="name_utama text-center"><?php echo $sdm['NAME']; ?></td>
                                            ...
                                            <td class="text-center"><button type="button" class="main_button small_btn update_main_sdm"><i class="ico-edit no_margin_right"></i></button> <a class="main_button small_btn" href="<?php echo 'do_remove_vendor_sdm/'.$sdm['SDM_ID']; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="ico-remove no_margin_right"></i></a></td>
                                        </tr>
                                            <?php }
                                        ?>
                            ...
                            <?php echo form_open('Vendor_update_profile/do_insert_sdm',array('class' => 'form-horizontal insert_support_sdm', 'autocomplete'=>'off')); ?>
                            ...
                            <?php echo form_close(); ?>
                            <div class="table-responsive">
                                <table class="table table-hover margin-bottom-20 panel <?php echo !isset($progress_status[$container]) ? 'panel-default' : ($progress_status[$container]['STATUS'] == 'Rejected' ? 'panel-danger' : 'panel-success') ?>" id="support_sdm">
                                    <thead>
                                        <tr>
                                            <th class="text-center">No</th>
                                            <th class="text-center">Nama</th>
                                    ...
                                    <tbody id="tableItem">
                                        ...
                                        <tr id="<?php echo $sdm['SDM_ID']; ?>">
                                            <td class="text-center"><?php echo $no++; ?></td>
                                            <td class="name_pendukung text-center"><?php echo $sdm['NAME']; ?></td>
                                            ...
                                            <td class="text-center"><button type="button" class="main_button small_btn update_support_sdm"><i class="ico-edit no_margin_right"></i></button> <a class="main_button small_btn" href="<?php echo 'do_remove_vendor_sdm/'.$sdm['SDM_ID']; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="ico-remove no_margin_right"></i></a></td>
                                        </tr>
                                            <?php }
                                        ?>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body text-right">
                                        <button id="save_sdm" class="main_button color2 small_btn" type="button">Save & Back</button>
                                    </div>
                                </div>
                        </div>
                    </div>
