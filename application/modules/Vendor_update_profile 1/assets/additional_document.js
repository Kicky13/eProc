$(document).ready(function(){
	...
	$('#addAffiliation_company').click(function(){
		...
		if(success){
			...
			$.ajax({
				url : 'do_insert_affiliation_company',
				method : 'post',
				data : form_data,
				success : function(result)
				{
