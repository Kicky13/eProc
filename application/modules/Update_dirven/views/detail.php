                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Klasifikasi<span style="color: #E74C3C">*</span></label>
                                <div class="col-sm-5">
                                    <label class="custom_select">
                                        <span class="lfc_alert"></span>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Sub Klasifikasi<span style="color: #E74C3C">*</span></label>
                                <div class="col-sm-9">
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-sm-9">
