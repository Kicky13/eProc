                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php 
                                        ...
                                        foreach ($item as $item) {
                                            ...
                                            echo '<td class="text-right quantity">'.$item['PQI_QTY'].'</td>';
                                            echo '<input type="hidden" name="qty['.$item['PQI_ID'].']" value="'.$item['PQI_QTY'].'">';
                                    ...
                                    <tfoot>
                                        ...
                                        <?php if($paqh['PAQH_PRICE_TYPE'] == 'T'): ?>
                                            <th class="text-right" id="subsatuantotal">0.00</th>
                                            <th class="text-right" id="total"><strong>0.00</strong></th>
                                        <?php else: ?>
                                            <th class="text-right" id="subsatuantotal"><strong>0.00</strong></th>
