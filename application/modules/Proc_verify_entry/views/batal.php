<section class="content_section">
    <div class="content_spacer">
        <div class="content">
            ...
            <div class="row">
                <form method="post" action="<?php echo base_url() ?>Proc_verify_entry/saveBatal" class="submit">
                    <input type="hidden" name="ptm" value="<?php echo $ptm ?>"></input>
                    <input type="hidden" name="proses" value="<?php echo $proses ?>"></input>
                    <input type="hidden" name="kembali" value="<?php echo $kembali ?>"></input>
                    <input type="hidden" name="index" value="<?php echo $index ?>"></input>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        Pilih item yang akan di batalkan
                      </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body text-center">
                            <a href="<?php echo base_url().$kembali.'/'.$index.'/'.$ptm; ?>" class="main_button color7 small_btn">Kembali</a>
                            <button id="submit-form" type="submit" class="main_button color6 small_btn">Batal</button>
                        </div>
                    </div>
                </form>
            </div>
