<?php //if($invitation_tender_items[0]['PPR_DOCTYPE']=='ZBS'): ?>
        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php endif ?>
                    <?php
                    $url = "Nego_invitation_vendor/do_update_tender_invitation/".$tender_invitation["PTV_ID"];
                        ...
                        <table class="table table-hover">
                            <tr>
                                ...
                                <td id="fileUpload">                                     
                                    ...
                                    <a href="<?php echo site_url('Nego_invitation_vendor/download_file/'.$ptnv_id); ?>" target="_blank" class="btn btn-default uploaded_file" style="float:left;" ><?php echo $FILE_UPLOAD;?></a>
                                    <?php }?>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-footer text-center">
                        	<?php if ($tender_invitation['PTV_TENDER_TYPE']==1 && $tender_invitation['PTV_APPROVAL']==4): ?>
                                <a href="<?php echo site_url('Nego_invitation_vendor'); ?>" class="main_button small_btn reset_button color7">Kembali</a>
                                &nbsp;&nbsp;Nego sudah di Approve Principal                                
                            <?php elseif ($tender_invitation['PTV_TENDER_TYPE']==2): ?>
                                <a href="<?php echo site_url('Nego_invitation_vendor'); ?>" class="main_button small_btn reset_button color7">Kembali</a>
                                &nbsp;&nbsp;Nego By Principal 
                            <?php else: ?>    
                                <a href="<?php echo site_url('Nego_invitation_vendor'); ?>" class="main_button small_btn reset_button color7">Kembali</a>
