            ...
            <div class="content_spacer">
                <div class="content">
                    <div class="main_title centered upper">
                        <h2><span class="line"><i class="ico-users"></i></span>Detil Item</h2>
                    </div>
                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                        	<form action="<?php echo base_url('List_pemenang/update_status') ?>" method="post" >
                            <input type="hidden" id="id_pemenang" name="id_pemenang" value="<?php echo $data[0]['ID_PEMENANG']; ?>" />
                            
                            
                            <div class="panel panel-default">
                              <div class="panel-heading centered"><input type="submit" name="submit" id="submit" class="btn btn-success " value="Penetapan Pemenang" /></div>
                              ...
                              <table id="job-list-table" class="table table-striped">
                               ...
                               <div class="panel-footer centered"><a href="<?php echo base_url('List_pemenang');?>"  id="batal" name="batal"  class="btn btn-info " >Batal </a></div>
                            </div>
							</form>
						</div>
					</div>
