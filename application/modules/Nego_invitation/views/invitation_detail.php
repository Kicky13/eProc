        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php endif ?>
                    <?php
                    $url = "Nego_invitation/do_update_tender_invitation/".$tender_invitation["PTV_ID"];
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php
                            if(!empty($detail_nego['DOC_NEGO'])){
                                ?>
                                <div class="form-group">
                                    <label for="FIRSTNAME" class="col-sm-3 control-label">Dokumen Nego</label>
                                    <label for="FIRSTNAME" class="col-sm-9 text-left control-label">
                                        <a target="_blank" href="<?php echo base_url() ?>upload/doc_nego/<?php echo $detail_nego['DOC_NEGO']; ?>"> <span class="glyphicon glyphicon-file"></span> <?php echo $detail_nego['DOC_NEGO']; ?> </a>
                                    </label>
                                </div>
                                <?php
                            } 
                    ...
                    <div class="panel panel-default">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    foreach ($invitation_tender_items as $key => $value) { 
                                        ...
                                        // menambah jika ada harga nego maka gunakan harga nego 5 april 2018
                                        if(!empty($harga_nego[$value['TIT_ID']]) || $harga_nego[$value['TIT_ID']]!=0){
                                            $nilai_def=$harga_nego[$value['TIT_ID']];
                                        }
                        ...
                        <div class="panel panel-default">
                            <div class="panel-footer text-center">
                                ...
                                <a href="<?php echo site_url('Nego_invitation'); ?>" class="main_button small_btn reset_button color7">Kembali</a>
