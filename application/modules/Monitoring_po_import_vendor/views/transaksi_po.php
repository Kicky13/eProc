			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						...
						<table id="example1" class="table tablee table-hover" >
							<thead>
						...
						<div id="home" class="tab-pane fade in active">
							<p>
								...
								<div class="form-group">
									...
									<div class="colm-sm-6">
										<input name="DOC_PPL" id="DOC_PPL" onchange="return ValidateFileUploadDOC_PO()" accept="application/msword, application/pdf" type="file">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="colm-sm-6">
										<input name="DOC_BILLING" id="DOC_BILLING" onchange="return ValidateFileUploadDOC_PO()" accept="application/msword, application/pdf" type="file">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="colm-sm-6">
										<input name="DOC_BPN" id="DOC_BPN" onchange="return ValidateFileUploadDOC_PO()" accept="application/msword, application/pdf" type="file">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="colm-sm-6">
										<input name="DOC_MANIFEST" id="DOC_MANIFEST" onchange="return ValidateFileUploadDOC_PO()" accept="application/msword, application/pdf" type="file">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="colm-sm-6">
										<input name="DOC_LS" id="DOC_LS" onchange="return ValidateFileUploadDOC_PO()" accept="application/msword, application/pdf" type="file">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="colm-sm-6">
										<input name="DOC_INSURANCE" id="DOC_INSURANCE" onchange="return ValidateFileUploadDOC_PO()" accept="application/msword, application/pdf" type="file">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="colm-sm-6">
										<input name="DOC_SPPB" id="DOC_SPPB" onchange="return ValidateFileUploadDOC_PO()" accept="application/msword, application/pdf" type="file">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="colm-sm-6">
										<input name="DOC_SPTNP" id="DOC_SPTNP" onchange="return ValidateFileUploadDOC_PO()" accept="application/msword, application/pdf" type="file">
									</div>
								</div>
						...
						<div id="menu1" class="tab-pane fade">
							<p>
								...
								<div class="form-group">
									...
									<div class="colm-sm-6">
										<input name="DOC_INVOICE" id="DOC_INVOICE" onchange="return ValidateFileUploadDOC_PO()" accept="application/msword, application/pdf" type="file">
									</div>
								</div>
