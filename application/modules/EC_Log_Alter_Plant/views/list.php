                            ...
                            <div class="panel-group skrol" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <table id="table_inv" class="table table-striped nowrap" width="100%">
                                        <thead>
                                        <tr>
                                            <th class="text-center ts0"><a href="javascript:void(0)">Company</th>
                                            <th class="text-center ts1"><a href="javascript:void(0)">Plant</a></th>
                                            <th class="text-center ts2"><a href="javascript:void(0)">Plant Desc</a></th>
                                            <th class="text-center ts3"><a href="javascript:void(0)">User</a></th>
                                            <th class="text-center ts4"><a href="javascript:void(0)">Date Log</a></th>
                                            <th class="text-center ts5"><a href="javascript:void(0)">Activity</a></th>
                                        </tr>
                                        <tr class="sear">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td class="text-center ts0"><a href="javascript:void(0)">Company</td>
                                            <td class="text-center ts1"><a href="javascript:void(0)">Plant</a></td>
                                            <td class="text-center ts2"><a href="javascript:void(0)">Plant Desc</a></td>
                                            <td class="text-center ts3"><a href="javascript:void(0)">User</a></td>
                                            <td class="text-center ts4"><a href="javascript:void(0)">Date Log</a></td>
                                            <td class="text-center ts5"><a href="javascript:void(0)">Activity</a></td>
                                        </tr>
                                        <tr>
                                            <td class="text-center ts0"><a href="javascript:void(0)">Company</td>
                                            <td class="text-center ts1"><a href="javascript:void(0)">Plant</a></td>
                                    ...
                                    <a><span title="Approve" class="glyphicon glyphicon-ok" aria-hidden="true"></span></a>&nbsp;&nbsp;
                                </div>
                            </div>
                        </div>
                    </div>
