			...
			<div class="row border-table" style="box-shadow: 1px 1px 1px #ccc">
				<div class="col-lg-9">
					<div class="row" style="margin-left: 1px; margin-right: 1px;">
						...
						<br>	
						<!-- Tanggal Transaksi : <?php //echo substr($po[$i]['DATE_BUY'], 0, 2).'/'.substr($po[$i]['DATE_BUY'], 3, 5).'/'.substr($po[$i]['DATE_BUY'], 0, 2)?> -->
						Tanggal Transaksi : <?php echo $po[$i]['DATE_BUY']?>
						<br>
				...
				<div class="col-lg-12">
					...
					<div class="row">
						<div class="col-md-2 padding-list">
							<img src="<?php echo base_url(UPLOAD_PATH) . '/EC_material_strategis/'.$list[$j]['PICTURE']?>" class="img-responsive"></a>
						</div>
						<div class="col-md-5 padding-list">
							...
							<br>	
							<?php echo $list[$j]['curr'].' '.number_format(($list[$j]['netprice']*100),0,",",".").'/'.$list[$j]['uom']?>
						</div>
						<!-- <div class="col-md-2 padding-list">
							<strong>Vendor</strong>
							<br>
						...
						<div class="col-md-2 padding-list">
							...
							<br>
							<?php 
								$sub = $list[$j]['QTY']*($list[$j]['netprice']*100);
