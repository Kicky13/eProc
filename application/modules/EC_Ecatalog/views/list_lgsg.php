        ...
        <div class="content" style="margin-left: 10px;margin-right: 10px">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 pull-right">
                    ...
                    <a href="<?php echo base_url(); ?>EC_Ecatalog/checkout_lgsg" style="box-shadow: 1px 1px 1px #ccc" type="button"
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    ...
                    <div class="row" style="margin-right: -5px;padding-left: 10px">
                        ...
                        <div class="col-lg-12"
                             style="overflow-y: auto; background-color: white;box-shadow: 1px 1px 1px 1px #ccc; max-height: 65vh;">
                            <ul id="tree1">
                    ...
                    <div class="row" style="margin-bottom: 5px">
                        ...
                        <div class="col-lg-2">
                            <div class="btn-group pull-right">
                                ...
                                <button type="button pull-right" style="box-shadow: 1px 1px 1px #ccc" onclick="modeList('grid')"
