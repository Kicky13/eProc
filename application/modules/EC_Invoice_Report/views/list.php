                                    ...
                                    <table id="table_inv" class="table table-striped nowrap" width="100%">
                                        <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center ts8"><a href="javascript:void(0)">Tipe PO</a></th>
                                                    <th class="text-center ts9"><a href="javascript:void(0)">Total Amount</a></th>
                                                    <th class="text-center ts10"><a href="javascript:void(0)">Status</a></th>
                                                    <th class="text-center ts10"><a href="javascript:void(0)">Keterangan</a></th>
                                                    <th class="text-center ts11"><a href="javascript:void(0)">Posisi Dokumen</a></th>
                                                    <th class="text-center ts12"><a href="javascript:void(0)">Status Dokumen</a></th>
