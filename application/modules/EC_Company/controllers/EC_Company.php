...
class EC_Company extends CI_Controller {
	...
	public function get_data() {
		...
		$dataa = $this -> EC_master_ecatalog -> getCOMPANY();
		$i = 1;
		$data_tabel = array();
	...
	public function ubahStat($MATNR) {
		...
		$this -> EC_master_ecatalog -> ubahStatCOMPANY($data);
	}
	...
	public function baru() {
		...
		$this -> EC_master_ecatalog -> insertCOMPANY($data);
		redirect("EC_Company/");
