                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data as $key => $value): ?>
                                        ...
                                        <?php foreach ( $value['item'] as $id => $val): ?>
                                            <?php if($id == 0): ?>
                                                <tr>
                                                    <td rowspan="<?php echo $value['nitem'] ?>"><a href="<?php echo base_url("Tender_winner_tonasa/releasePO/".$value['PO_ID'])?>" target="_blank" title="Click - view - print PO"><?php echo $value['PO_NUMBER'] ?></a></td>
                                                    <td rowspan="<?php echo $value['nitem'] ?>"><a href="<?php echo base_url("Tender_winner_tonasa/detailPO/".$value['PO_ID'])?>" target="_blank" title="Click - view - print LP3"><?php echo $value['LP3_NUMBER'] ?></a></td>
                                                    <td rowspan="<?php echo $value['nitem'] ?>"><?php echo $value['PTM_PRATENDER'] ?></td>
                                                    <td class="text-center <?php echo $value['IS_APPROVE']==0?'waiting':($value['IS_APPROVE']==1?'approved':($value['IS_APPROVE']==2?'rejected':($value['IS_APPROVE']==3?'renego':($value['IS_APPROVE']==4?'retender':'canceled')))); ?>" rowspan="<?php echo $value['nitem'] ?>"><a href="<?php echo base_url("Tender_winner_tonasa/detailPO/".$value['PO_ID'])?>" target="_blank" title="Click - view - print LP3"><?php echo $value['status_po'] ?></a></td>
