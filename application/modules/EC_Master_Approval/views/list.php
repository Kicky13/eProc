                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <table id="table_inv" class="table table-striped nowrap" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center ts1"><a href="javascript:void(0)">Value From</a></th>
                                            <th class="text-center ts2"><a href="javascript:void(0)">Value To</a></th>
                                            <th class="text-center ts3"><a href="javascript:void(0)">Username</a></th>
                                            <th class="text-center ts4"><a href="javascript:void(0)">ID User</a></th>
                                            <th class="text-center ts5"><a href="javascript:void(0)">Progress CNF</a></th>
                                            <th class="text-center ts6"><a href="javascript:void(0)">User Akses</a></th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center ts6"><a href="javascript:void(0)">Commit Date</a></td>
    ...
    <div class="modal-dialog modal-md" style="width:75%">
        <div class="modal-content">
            ...
            <div class="row" style="padding: 5px;">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                    <input type="text" name="viewvalueFrom" id="viewvalueFrom" placeholder="Value From">
                </div>                
            </div>
            <div class="row" style="padding: 5px;">
                <div class="col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                    <input type="text" name="viewvalueTo" id="viewvalueTo" placeholder="Value To">
                </div>                
            </div>
            <div class="row" style="padding: 5px;">
                <div class="col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="row" style="padding: 5px;">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                    <div class="form-group" id="modalbudget">
                        <select class="form-control CC2" name="viewuserakses" id="viewuserakses" style="width: 250px;">
                            <option value="0" selected="">Pilih User Akses</option>
                            <option value="KA">User KA</option>
                            <option value="GUDANG">User Gudang</option>
                        </select>
            ...
            <div class="row" style="padding: 5px;">
                ...
                <div class="col-sm-4 col-md-4 col-lg-4">
                    <input type="text" name="viewcnf" id="viewcnf" placeholder="Progress CNF">
                </div>                
            </div>
            <div class="row" style="padding: 5px;">
                <div class="col-sm-3 col-md-3 col-lg-3">
