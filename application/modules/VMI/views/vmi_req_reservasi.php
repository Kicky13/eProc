...
<section class="content_section">
	<form class="form-horizontal" action="<?=base_url('VMI/Company/reservasi')?>" method="POST">	
		<div class="content_spacer">
			<div class="content">
				<div class="main_title centered upper">
					<h2><span class="line"><i class="ico-users"></i></span>Cari Reservasi</h2>
				</div>
				<div class="row">
					<div class="form-group">
						<div class="col-sm-2 col-sm-offset-3">
							<label for="inputPlant" class="control-label">Nomor Reservasi : </label>
						</div>
						<div class="col-sm-3">
							<input type="text" class="form-control" id="NO_RESERVASI" name="NO_RESERVASI" value = '0051554956'>								
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-2 col-sm-offset-3">
					...
					<div class="form-group">
						<div class="col-sm-2 col-sm-offset-3">
							<label for="inputPlant" class="control-label">Storage Location : </label>
						</div>
						<div class="col-sm-3">
							<select name = 'plant'>
