			...
			<div class="content_spacer">
				<div class="content">
					<div class="main_title centered upper">
						<h2><span class="line"><i class="ico-users"></i></span>GR List</h2>
					</div>
					<div class="row">
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<input type="text" value="" id="listreceive" name="listreceive">
									<input type="submit" class="btn btn-default">
									</form>-->
									<table class="table table-hover" id="vmi_list_gr">
										<thead>
											<tr>
