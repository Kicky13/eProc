                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        if (!empty($vendor_detail["API_NO_DOC"])) { ?>
                                                            <label class="control-label"><span class="messageUpload"><a style="color: #666; text-decoration: underline" target="_blank" href="<?php echo base_url('Vendor_management')."/viewDok/".$vendor_detail["API_NO_DOC"]; ?>" title="File Attachment">File Attachment</a></span></label>
                                                        <?php
                                                        } ?>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" name="account_group" id="account_group">
                                                                ...
                                                                ?>
                                                                    <option value="<?php echo $val['GROUP']?>"><?php echo $val['ACC_GROUP_ID']?> - <?php echo $val['NAME'] ?> - <?php echo $val['VENDOR_TYPE'] ?></option>
                                                                <?php
                                                                }
                                                                ?>
                                                            </select>
