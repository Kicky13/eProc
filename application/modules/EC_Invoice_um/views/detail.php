                              ...
                              */
                              if(!empty($lot)){
                                ...
                                foreach ($lot as $value) {
                                    $link .= '
                                    <div class="link"><a href="#" data-nopo="'.$invoice[0]['NO_SP_PO'].'" data-tipe="RR" data-iddokumen="'.$value['LOT_NUMBER'].'" data-url="'.base_url('EC_Invoice_Management/showDocument').'" data-print_type="'.$value['PRINT_TYPE'].'" onclick="return showDocument(this)"><u>Lot Number '.$value['LOT_NUMBER'].'</u></a></div>';
                                }
                                echo '<div class="col-sm-3 col-md-offset-3">'.$link.'</div>';
                              }
