...
<table class="noborder" widht='100%' style="margin-top:10px">
    <tr>
        ...
        <td>
            <?php 
            if($data['poHeader']['CO_CODE'] == "5000" || $data['poHeader']['CO_CODE'] == 5000) {
                echo "Kabiro Pengadaan";
            } else {
                echo "Kabiro. Pengelolaan Persediaan";
            }
            ?>
        </td>
        ...
        <td>
            <?php 
            if($data['poHeader']['CO_CODE'] == "5000" || $data['poHeader']['CO_CODE'] == 5000) {
                echo "Kasi Persediaan & Penerimaan";
            } else {
                echo "Kasi. Penerimaan Barang";
            }
            ?>
        </td>
    </tr>
    ...
    <tr>
        <td style="width:150px"></td>
        <td><?php echo $ambil_approval['APPROVED2_BY']; ?></td>
        <td style="width:30px"></td>
        <td><?php echo $ambil_approval['APPROVED1_BY']; ?></td>
    </tr>
</table>
