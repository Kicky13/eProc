              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-md-2">
                      ...
                      <a href="<?php echo base_url('Invoice/email') ?>" id="button_tambah" class="btn btn-success btn-block">kirim email</a>
                  </div>
                </div>
            </div>
          </div>
                                ...
                                <div class="form-group" style="display: flex; margin-top: 15px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="colm-sm-6">
                                            ...
                                            <!-- <div class="col-sm-3">
                                                        <?php
                                                        if (!empty($set_edit['FILE_PAJAK'])) { ?>
                                                            <label class="control-label"><span class="messageUpload"><a style="color: #666; text-decoration: underline" target="_blank" href="<?php echo base_url('Vendor_management')."/viewDok/".$set_edit['FILE_PAJAK']; ?>" title="File Attachment">File Attachment</a></span></label>
                                                        <?php
                                                        } ?>
                                            </div> -->
                                        </div>
