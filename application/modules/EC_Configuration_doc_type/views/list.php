              ...
              <table id="tableMT" class="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th class="text-center ts1"><a href="javascript:void(0)">Category</a></th>
                    <th class="text-center ts2"><a href="javascript:void(0)">Document Type</a></th>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <h4 class="modal-title text-center"><u>Add Configuration &ndash; Document Type</u></h4>
        </div>
        <div class="modal-body">        	 	
          	<?php echo form_open_multipart('EC_Configuration_doc_type/baru/', array('method' => 'POST', 'class' => 'form-horizontal')); ?>
				  <div class="form-group">
				    <label for="CATEGORY" class="col-sm-2 control-label">Category</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="CATEGORY" name="CATEGORY" value="K"  readonly>
				    </div>
				  </div> 
