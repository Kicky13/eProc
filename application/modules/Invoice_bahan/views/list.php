        ...
        <div class="modal-body">
        	<div class="row">
        		<div class="col-sm-12 col-lg-12 col-lg-12">
        			<?php echo form_open_multipart('EC_Open_invoice/createINV/', array('method' => 'POST', 'class' => 'form-horizontal')); ?>
				  <div class="form-group">
				   ...
				   <div class="form-group">
				    ...
				    <div class="col-sm-4">
				      <input type="text" class="form-control" required name="faktur" >
				    </div>
				    <div class="col-sm-3">
				   ...
				   <div class="form-group">
				    ...
				    <div class="col-sm-4">
				      <input type="text" class="form-control" name="total" id="totalview" readonly="">
				    </div>
				  </div> 
				   <div class="form-group">
