...
<head>
    <title>
        USULAN PERMINTAAN PENAWARAN KE VENDOR
    </title>
</head>
<div style="width:670px;padding:10px;border: 1px solid black;">
    <div style="width:100%;">
        <div style="height:25px;">
            ...
            <div style="padding-top:4px;width:67.3%; height:25px;float:left;text-align:center">
                <strong>
                    USULAN PERMINTAAN PENAWARAN KE VENDOR
                </strong>
            </div>
        ...
        <div style="height:25px;">
            <div style="width:485px; height:25px;float:right;text-align:center;">
                <strong>
    ...
    <div style="width:100%;">
        <table border="1" style="width:100%; font-size:8pt;">
            ...
            <tr>
                <td colspan="2"><strong>MATERIAL GROUP</strong></td>
            ...
            <tr>
                <td colspan="2"><strong>SUB MATERIAL GROUP</strong></td>
            ...
            ?>
            <tr>
                <td style="width:20%" colspan="2"><strong>ESTIMASI NILAI</strong></td>
          ...
          <?php if($ptm['IS_JASA'] == 0) {?>
            ...
            <?php } ?>
          <?php } else { ?> <!-- jika jasa -->
            <?php foreach ($pti as $jasa) { ?>
                <tr>
                    <td style="width:15%"><?php echo $jasa['PPI_PRNO']; ?></td>
                    <td  style="width:5%; text-align:center"><?php echo $jasa['PPI_PRITEM']; ?></td>
                    <td style="width:35%"><?php echo $jasa['PPI_DECMAT']; ?></td>
                    <td  style="width:10%;text-align:right;"><?php echo number_format($jasa['TIT_PRICE']); ?></td>
                    <td style="width:25%"></td>
                    <td  style="width:7%;text-align:center;"><?php echo $jasa['TIT_QUANTITY']; ?></td>
                    <td style="width:3%;text-align:center;"><?php echo $jasa['PPI_UOM']; ?></td>
                </tr>
            <?php } ?>
          <?php } ?>
        </table>
    ...
    <br>
    <div style="width:100%;height:100px; font-size:8pt">
