	...
	<div class="content_spacer">
		<div class="content">
			...
			<div class="row">
				<div class="col-md-12">
					<?php
					$url = "Tender_invitation_vendor/do_update_tender_invitation/".$ptv_id;
                    ...
                    <?php endif; ?>
                    <?php if($tender_invitation['PTV_TENDER_TYPE']==1){?>
					<div class="panel panel-default">
					...
					<div class="panel panel-default">
						<div class="panel-body text-center">
							<a href="<?php echo site_url('Tender_invitation_vendor'); ?>" class="main_button small_btn reset_button">Kembali</a>&nbsp;
