 ...
 */
 (function(){var language = {delimiters: {thousands: ' ',decimal: ','},abbreviations: {thousand: 'rb',million: 'jt',billion: 'ml',trillion: 't'},ordinal : function (number) {return number;},currency: {symbol: 'Rp. '}};if (typeof module !== 'undefined' && module.exports) {module.exports = language;}if (typeof window !== 'undefined' && this.numeral && this.numeral.language) {this.numeral.language('id', language);}}());