...
function loadTable_App() {
    ...
    mytable = $('#table_report').DataTable({
        ...
        "ajax": {
                url: $("#base-url").val() + 'EC_Report_Penawaran/getReport',
                // type: 'POST',
                dataType: 'json',
                data: {
        ...
        "columns": [/*{
            ...
            mRender: function (data, type, full) {
                // console.log(full.NAMA_PLANT);
                a = "<div class='col-md-12'>";
                a += full.PLANT+" - "+full.NAMA_PLANT;
                a += "</div>";
                return a;
            }
        }, {
            ...
            mRender: function (data, type, full) {
                a = "<div class='col-md-12 text-center'>";
                a += full.DELIVERY_TIME+" Days";
                a += "</div>";
                return a;
            }
        },{
            mRender: function (data, type, full) {
                a = "<div class='col-md-12 text-center' style='color: blue;'>";
                a += "<strong>"+full.LAST_UPDATE+"</strong>";
                a += "</div>";
                return a;
            }
        }],
...
var t0 = true,
    ...
    clicks = 0,
    timer = null;
var tt1 = [t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11];
var tt2 = [t1, t2, t3, t4, t5, t6, t7, t8, t9, t10];
var tt3 = [t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15];
var items = []
var itemShipment = []
var itemship = []
$(document).ready(function () {
    ...
    //     console.log( value.matno + ' : ' + value.plant );
    // });
    ...
    $('#showReport').click(function () {
        // loadTable_App($('#material').val(), $('#plant').val());
    });
...
function showReport(matno, plant) {
    $.ajax({
