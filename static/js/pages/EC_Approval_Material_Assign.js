...
function loadTable_() {
    ...
    mytable = $('#table_inv').DataTable({
        ...
        "ajax": $("#base-url").val() + 'EC_Approval_Material_Assign/getMaterial_approval',
...
function approve(KODE) {
    bootbox.confirm('Konfirmasi Approve Assign?', function (result) {
        if (result)
            window.location.href = $("#base-url").val() + 'EC_Approval_Material_Assign/approve/' + KODE
    });
}
...
function reject(KODE) {
    bootbox.confirm('Konfirmasi Reject Assign?', function (result) {
        if (result)
            window.location.href = $("#base-url").val() + 'EC_Approval_Material_Assign/reject/' + KODE
    });
}
