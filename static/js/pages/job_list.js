            ...
            //{"data" : "PROCESS_NAME"},
            {
                mRender : function(data,type,full) {
                    if (full.PTM_STATUS > 0){
                        if (full.PTM_STATUS == 3 && full.TAMBAHAN_APPROVAL_NAME!="") {
                            return full.TAMBAHAN_APPROVAL_NAME;
                        }
                        if (full.PTM_STATUS == 19 && full.PENAWARAN_KE!="") {
                            return 'Konfigurasi Undangan Penawaran Harga Ke '+full.PENAWARAN_KE;
                        }
                ...
                {"data" : "PTC_END_DATE"},
                {
                    mRender : function(data,type,full){
                        ...
                        if (full.PTM_STATUS == 19 && full.PENAWARAN_KE!="") {
                            var button = '<a href="' + $("#base-url").val() + 'Procurement_undang_harga/index/'+full.PTM_NUMBER+'" class="btn btn-default">Proses</a>'+'<span id="status_'+full.PTM_NUMBER+'" class="status_uptodate"></span>';
                        }
                        return button;
                    }},
                    ],
