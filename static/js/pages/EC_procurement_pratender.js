...
function loadTable() {
    ...
    mytable = $('#pr-list-table-perencanaan').DataTable({
        "ajax" : {'url':base_url + 'EC_Procurement_pratender/get_datatable','type': 'POST',
            'data': function(d){d.jenis_perencanaan=$('#jenis_perencanaan').val()},
        } ,
       //"ajax" : $("#base-url").val() + 'EC_Procurement_pratender/get_datatable',
        "ordering": false,
        "dom": 'rtip',
        "lengthMenu": [ 10, 25, 50 ],
        "columnDefs": [{
...
function dokumenPR(e){
    ...
    $.ajax({
        url : $("#base-url").val() + 'EC_Procurement_pratender/search_dokumenPR/',
        dataType : 'html',
        method : 'post',
        data : {ppi_id},
...
$(document).ready(function(){
    ...
    $('.generate_vendor').click(function(){
        ...
        $.ajax({
            url: $("#base-url").val() + 'EC_Procurement_pratender/get_vendor',
            type: 'POST',
            dataType: 'json',
    ...
    $(".generate_po").click(function() {
        ...
        $.ajax({
            url: $("#base-url").val() + 'EC_Procurement_pratender/get_po',
            type: 'POST',
            dataType: 'html',
            data: {tits: tits, just: just},
    ...
    $("#ptp_template_evaluasi").change(function(event) {
        // alert($(this).val());
        $.ajax({
            url: $("#base-url").val() + 'EC_Procurement_pratender/get_detail_template/' + $(this).val(),
            type: 'get',
            dataType: 'json',
        }).done(function(data) {
...
function vendorExpired(no_vendor, status){
    $.ajax({
        url: $("#base-url").val() + 'EC_Procurement_pratender/vendor_expired',
        type: 'POST',
        dataType: 'json',
