  ...
  _form.submit(function(e){
      ...
      if(_pajak != 'VZ'){
        ...
        if(!_error){
          ...
          var _id_invoice = _form.find('input[name=id_invoice]').val();
          var _invoice_date = _form.find('input[name=invoice_date]').val();
          $.get(_url,{no_faktur : hanyaAngka(_nomerPajak), no_po : _po, id_invoice : _id_invoice, invoice_date : _invoice_date },function(data){
            if(data.status){
              currentForm.submit();
            }else{
