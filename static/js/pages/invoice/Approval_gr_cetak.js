...
function loadTable() {
    ...
    mytables = $('#datatable_ajax').DataTable({
        "bSort": true,
        "dom": 'rtpli',
        "deferRender": true,
        "colReorder": true,
    ...
    mytables.columns().every(function () {
        var that = this;
    ...
    var clicks = 0;
    mytables.on("click", 'thead>tr>th.ts', function (e) {
        clicks++;
        if (clicks === 1) {
...
$(document).ready(function () {
    ...
    /* View Detail GR*/
    mytables.on('click', '.btn-rowedit', function (e) {
        e.preventDefault();
