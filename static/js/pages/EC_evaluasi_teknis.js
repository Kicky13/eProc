...
$(document).ready(function(){
	id = $('#ptp_template_evatek').val();
	id_ptm = $('#ptm_number').val();
	$.ajax({
            url : $("#base-url").val() + 'EC_Evaluasi_penawaran/get_evaluasi_detail/',
            dataType : 'html',
            method : 'post',
            data : {id, id_ptm},
	...
	$("#deptselect").change(function() {
		...
		$.ajax({
			url: $("#base-url").val() + 'EC_Evaluasi_penawaran/get_emp/' + deptval,
			type: 'get',
			dataType: 'json',
		})
		.done(function(data) {
    ...
    $('.uploadAttachment').each(function(event) {
        ...
        var uploader = new ss.SimpleUpload({
            button: btn,
            url: $("#base-url").val() + 'EC_Evaluasi_penawaran/uploadAttachment',
            name: 'uploadfile',
    ...
    $('.del_upload_file').click(function(){
        $.ajax({
            url: $("#base-url").val() + 'EC_Evaluasi_penawaran/deleteFile/'+$("#file_pesan").val(),
            type: 'POST',
            data: {},
            beforeSend: function() {
    ...
    $('#save_chat').click(function(){
        ...
        $.ajax({
            url : $("#base-url").val() + 'EC_Evaluasi_penawaran/save_pesan/',
            dataType : 'html',
            method : 'post',
	...
	$("#vendor_pesan").change(function(){
		...
		ptm_number = $('#ptm_number').val();
		$.ajax({
            url : $("#base-url").val() + 'EC_Evaluasi_penawaran/filter_chat_vendor/',
            dataType : 'html',
            method : 'post',
	...
	$("#search").click(function(){
		...
		$.ajax({
            url : $("#base-url").val() + 'EC_Evaluasi_penawaran/search_assign/',
            dataType : 'html',
            method : 'post',
...
function replay(id){
	$.ajax({
        url : $("#base-url").val() + 'EC_Evaluasi_penawaran/replay_pesan/',
        dataType : 'json',
        method : 'post',
        data : {id},
        beforeSend: function() {
