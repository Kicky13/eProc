$(document).ready(function(){
    ...
    var table_job_list = $('#hapus-pengadaan-list-table').DataTable({
        "ajax" : $("#base-url").val() + 'Batal_pengadaan/get_datatable',
        ...
        "columns":[
            ...
            {"data" : "PTC_END_DATE"},
            {
                mRender : function(data,type,full){
                console.log(full);
                return '<a href="' + $("#base-url").val() + 'Batal_pengadaan/detail/'+full.PTM_NUMBER+'" class="btn btn-default">Proses</a>'
            }},
        ],
    });
