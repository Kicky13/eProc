...
$(document).ready(function(){
	var table_invitation_lsit = $('#invitation_lsit').DataTable({
		...
		"lengthMenu": [ 10, 25, 50 ],
		"ajax": {
			url: base_url + "Tender_invitation/get_invitation_list"
		},
		"columnDefs": [{
			"targets": 0
		}],
		"columns":[
			...
			}, "sClass": "text-center"},
			{
				mRender : function(data,type,full){
				if (full.PTV_STATUS == null) {
					return '<a class="btn btn-default" href="'+base_url+'Tender_invitation/detail_invitation/'+full.PTV_ID+'">Process</a>'
				} else {
