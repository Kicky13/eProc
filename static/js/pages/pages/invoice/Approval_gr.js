function loadTable() {
    ...
    mytable = $('#datatable_ajax').DataTable({
        ...
        "ajax": $("#base-url").val() + 'EC_Approval/Gr/data/14',
        "columnDefs": [{
                "searchable": false,
                "orderable": true,
                "targets": 0
...
function manualRefreshGR_landed(elm) {
    var _url = $(elm).data('href');
    var _hariini = $(elm).data('hariini');
    bootbox.prompt('Masukkan Tanggal UD Analisa Mutu', function (t) {
        if (t) {
...
function loadTable_loted() {
    ...
    mytable_loted = $('#data_loted').DataTable({
        ...
        "ajax": $("#base-url").val() + 'EC_Approval/Gr/data_loted',
        "columnDefs": [{
                "searchable": false,
                "orderable": true,
                "targets": 0
