...
function createInvoice(elm) {
    ...
    if (grTerpilih.length) {
        var jumlah = 0,no_po, curr, gr, itemCat,no_rr = {}, _tmpgr, _tmprr,_cariBapp = [],rr_ref_fp=[],_no_ba=[],print_type;
        ...
        grTerpilih.each(function() {
            ...
            /* TAMBAHAN UNTUK PARCIAL INVOICE*/
        ...
        bootbox.dialog({
            ...
            if(!empty(no_rr)){
              ...
              if(_lot_no != null ){
                _link = [];
                _link.push('<div class="link"><a href="#" data-nopo="'+no_po+'" data-tipe="'+_typeDocument+'" data-iddokumen="'+_lot_no+'" data-url="'+_url+'" data-print_type='+print_type+' onclick="return showDocument(this)"> Lot Number '+_lot_no+'</a></div>');
              }
