...
$(document).ready(function(){
    ...
    var table_job_list = $('#prc-tender-winner-list-table-contract').DataTable({
		"ajax" : $("#base-url").val() + 'Tender_winner/get_datatablecontract/',
        ...
        "columns":[
            ...
            {"data" : "PPR_PGRP"},
            {
                mRender : function(data,type,full){
                    ...
                    // console.log(full);
                    // var ans = '<form action="'+$("#base-url").val()+'Tender_winner/delete" method="POST">';
    ...
    var table_job_list = $('#prc-tender-winner-list-table-rfq').DataTable({
        "ajax" : $("#base-url").val() + 'Tender_winner/get_datatablerfq/',
    ...
    var table_job_list = $('#po-header-list-table').DataTable({
        "ajax" : $("#base-url").val() + 'Tender_winner/get_datatable_po_header/',
