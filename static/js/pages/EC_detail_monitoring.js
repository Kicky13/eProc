...
function loadDataList() {
    ...
    $.ajax({
        url: $("#base-url").val() + 'EC_PL_Monitoring_Penawaran/getDetail_penawaran',
        data : {
            "vendor" : vendor,
            "limitMin" : limitMin,
            "limitMax" : limitMax
        ...
        if (data.data.length == 0) {
            ...
            for (var i = limitMin; i < data.data.length; i++) {
                ...
                teks +=	"<tr>" +
                    ...
                    // "<td rowspan='" + data.data[i].ISI.length + "'>" + data.data[i].STOK +
                    // '<a hidden href="javascript:updateStock(\'' + data.data[i].MATNO + '\',\'' + data.data[i][13] + '\',' + (data.data[i].STOK_COMMIT == "" ? 0 : data.data[i].STOK_COMMIT) + ',' + i + ',' + (data.data[i].STOK == "" ? 0 : data.data[i].STOK) + ')" style="font-size:12px;margin-top:2px;" class="btn btn-info btn-block">Update</a>' +
                    "</td>" +
                ...
                if(data.data[i].ISI.length > 0) {
                    teks +=	"" +
                        ...
                        "<td><center><input disabled type='text' value='" + data.data[i].ISI[0].PRICE + "' style='width:70px;' placeholder='0' name='price[D"+i+"0]'"+diselm+"></center></td>" +
                        "<td><center><input disabled type='text' value='" + data.data[i].ISI[0].DELIVERY_TIME + "' style='width:30px;' placeholder='0' name='dlvtime[D"+i+"0]'"+diselm+">&nbsp;day(s)</center></td>" +
                    ...
                    for(var j = 1; j < data.data[i].ISI.length; j++) {
                        ...
                        teks +=	"<tr>" +
                            ...
                            "<td><center><input disabled type='text' value='" + data.data[i].ISI[j].PRICE + "' style='width:70px;' placeholder='0' name='price[D"+i+j+"]'"+diselm+"></center></td>" +
                            "<td><center><input disabled type='text' value='" + data.data[i].ISI[j].DELIVERY_TIME + "' style='width:30px;' placeholder='0' name='dlvtime[D"+i+j+"]'"+diselm+">&nbsp;day(s)</center></td>" +
