...
function loadTable() {
    ...
    mytable = $('#table_vnd').DataTable({
        ...
        "ajax": $("#base-url").val() + 'EC_PL_Monitoring_Penawaran/getData_vendor',
        ...
        "columns": [{
            ...
            mRender: function (data, type, full) {
                a = "<div class='col-md-12 text-center'>";
                a += "<a href='"+ $("#base-url").val() +"/EC_PL_Monitoring_Penawaran/detail_penawaran/"+ full.VENDORNO +"' data-vendorno='" + (full.VENDORNO) + "' data-matno='" + (full.MATNO) + "'><span title='Lihat Detail' class='glyphicon glyphicon-search' aria-hidden='true'></span></a>";
                a += "</div>";
                return a;
            }
        }],
