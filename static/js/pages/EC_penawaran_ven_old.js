...
function loadDataList() {
    ...
    $.ajax({
        url: $("#base-url").val() + 'EC_Penawaran_Vendor' + urlll,
        data : {            
            "limitMin" : limitMin,
            "limitMax" : limitMax            
        },
            ...
            for (var i = limitMin; i < data.data.length; i++) {
                ...
                teks += ('<div class="row">')
                    teks += ('<div class="form-group">')
                        ...
                        teks += ('<textarea class="form-control" rows="3" id="deskrip'+i+'">' + data.data[i].DESKRIPSI + '</textarea>')
                    teks += ('</div>')
                teks += ('</div>')
                teks += ('<div class="row">')
                ...
                teks += ('<div class="col-md-1" style="text-align: center; margin-top: 20px;">')// + '<form class="form-horizontal">' )
                        ...
                        teks += ('<div class="panel panel-default">')
                            teks += ('<div class="panel-heading" role="tab" id="accord-item'+i+'">')
                                teks += ('<h5 class="panel-title">')
                                    teks += ('<a role="button" data-toggle="collapse" data-parent="#accordion'+i+'" href="#item'+i+'" aria-expanded="true" aria-controls="item'+i+'" onclick="getDetail(this,\'table_detail' + i + '\',\'' + i + '\',\'' + data.data[i].MATNO + '\',\'' + data.data[i].VENDORNO + '\',\'' + data.data[i].CURRENCY + '\')"><strong>Detail Pricelist</strong></a>')
                                teks += ('</h5>')
                            teks += ('</div>')
