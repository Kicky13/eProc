...
function openmodal (ID_ITEM) {
  // MATNR='341-107-0083';//341-107-0083  301-200410
    $.ajax({
        url: $("#base-url").val() + 'EC_Auction_bobot/getDetailItem/' + ID_ITEM,
        type: 'get',
        dataType: 'json',
    })
    .done(function(data) { 
         ...
         dt = data.ID_ITEM[0];
	         if(dt!=null){
	         $("#formUp").attr("action", "EC_Auction_bobot/updateItem/" + dt.MATNR);  
...
function openmodal1 (KODE_VENDOR) {
  // MATNR='341-107-0083';//341-107-0083  301-200410
    $.ajax({
        url: $("#base-url").val() + 'EC_Auction_bobot/getDetailUser/' + KODE_VENDOR,
        type: 'get',
        dataType: 'json',
    })
    .done(function(data) { 
         ...
         dt = data.KODE_VENDOR[0];
	         if(dt!=null){
	         $("#formUp").attr("action", "EC_Auction_bobot/updateUser/" + dt.MATNR);  
	         ...
	         $("#NILAI_TEKNIS").val(dt.NILAI_TEKNIS);
